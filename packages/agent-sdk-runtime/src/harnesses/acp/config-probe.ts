...
type AcpConfigProbeInput = {
  cached(): AgentConfigOptionRow[] | null
...
export async function probeAcpConfigOptions(input: AcpConfigProbeInput): Promise<AgentConfigOptionRow[]> {
  ...
  if (process.cachedConfigOptions) return process.cachedConfigOptions as AgentConfigOptionRow[]
  ...
  return process.cachedConfigOptions as AgentConfigOptionRow[]
}
