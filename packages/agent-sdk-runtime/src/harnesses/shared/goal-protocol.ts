 ...
 *
 * `GOAL_PROMPT_TEXT` is that contract's literal surface: harness-independent
 * text, mirrored by the OpenCode engine's own copy of this module and pinned
 * there by a conformance test, because the two packages have no shared
