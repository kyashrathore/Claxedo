...
import { ExecutionBudgetSchema, ExecutionProfileDefaultsSchema, WorkGraphDefaultsSchema } from "./execution"
import {
  RunIDSchema,
  DecisionIDSchema,
  EvidenceIDSchema,
...
export const CreateStreamCommandSchema = z.strictObject({
  ...
  budgetCarve: ExecutionBudgetSchema.optional(),
  execution: ExecutionProfileDefaultsSchema.optional(),
  confirmAutonomy: z.boolean().optional(),
...
export const SetStreamCharterCommandSchema = z.strictObject({
  ...
  compiled: ExecutionProfileDefaultsSchema.optional(),
  confirmAutonomy: z.boolean().optional(),
})
...
export const RecordLandingConflictCommandSchema = z.strictObject({
  version,
  type: z.literal("record_landing_conflict"),
  streamId: StreamIDSchema,
  workItemId: WorkItemIDSchema,
  reason: text.max(4_000),
})
export type RecordLandingConflictCommand = z.infer<typeof RecordLandingConflictCommandSchema>
...
export const ArmWorkItemCommandSchema = z.strictObject({
  version,
  type: z.literal("arm_work_item"),
  workItemId: WorkItemIDSchema,
  expectedVersion,
})
export type ArmWorkItemCommand = z.infer<typeof ArmWorkItemCommandSchema>

export const ArmWorkItemsCommandSchema = z.strictObject({
  version,
  type: z.literal("arm_work_items"),
  items: z
    .array(
      z.strictObject({
        workItemId: WorkItemIDSchema,
...
export type ArmWorkItemsCommand = z.infer<typeof ArmWorkItemsCommandSchema>
...
export const RestartRunCommandSchema = z.strictObject({
  version,
  type: z.literal("restart_run"),
  runId: RunIDSchema,
  expectedVersion,
  reason: text,
})
...
export const WorkGraphCommandSchema = z.discriminatedUnion("type", [
  ...
  RecordLandingConflictCommandSchema,
  ...
  ArmWorkItemCommandSchema,
  ArmWorkItemsCommandSchema,
