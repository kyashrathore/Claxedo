...
/** Create an ITriggerStore backed by the given SQLite Database instance. */
export function openSqliteTriggerStore(db: SqliteInput): ITriggerStore {
  return new SqliteTriggerStore(sqlite(db));
}
