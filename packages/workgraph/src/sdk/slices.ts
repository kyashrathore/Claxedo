...
function toSliceRow(db: SqliteDb, raw: any): SliceRow {
...
/** Create an ISliceStore backed by the given SQLite database. */
export function openSqliteSliceStore(db: SqliteInput): ISliceStore {
  return new SqliteSliceStore(sqlite(db))
}
