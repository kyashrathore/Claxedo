...
const commandSamples = [
  ...
  },
  {
    ...
    budgetCarve: { amount: 1_000, unit: "tokens", window: "stream" },
  },
  {
    version: 1,
    type: "update_stream",
  ...
  { version: 1, type: "restart_run", runId: "run-1", expectedVersion: 1, reason: "Fresh run" },
  ...
  { version: 1, type: "delete_stream", streamId: "stream-1", expectedVersion: 5, reason: "Discard draft" },
  {
    ...
    compiled: { maxParallel: 4, mayPromote: true },
  },
  { version: 1, type: "call_master", streamId: "stream-1", expectedVersion: 5, message: "Rebase before landing." },
  {
    ...
    reason: "Candidate conflicts with the moving envelope head.",
  },
  {
    version: 1,
