...
export { createIntegrationRegistry, type IntegrationRegistry, type RegisteredIntegration } from "./registry.js"
// The capability ports. A host registering an integration from JavaScript
// needs the marker consts; a host written in TypeScript needs the types to
// state what its impl serves.
export {
  CAPABILITIES,
  capabilitiesOf,
  channelPort,
