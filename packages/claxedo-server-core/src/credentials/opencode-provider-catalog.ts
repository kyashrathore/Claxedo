...
import { credentialOrg, requireProviderAuthCredential, type CredentialOrgScope } from "./registry"
...
function providerConnected(
  ...
  if (requireProviderAuthCredential(id, org)?.status === "available") return true
