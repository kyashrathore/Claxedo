...
beforeAll(async () => {
  mock.module("../../claxedo-ui/content-renderers/session-content", () => ({
    SessionContent: () => null,
  }))
  mock.module("../../claxedo-ui/content-renderers/terminal-content", () => ({
    TerminalContent: () => null,
  }))
  mock.module("../../claxedo-ui/content-renderers/page-content", () => ({
    PageContent: () => null,
  }))
  mock.module("../../claxedo-ui/content-renderers/context-content", () => ({
    ContextContent: () => null,
  }))
  mock.module("../../claxedo-ui/content-renderers/pages-index-content", () => ({
    PagesIndexContent: () => null,
  }))
  mock.module("../../claxedo-ui/content-renderers/marketplace-content", () => ({
