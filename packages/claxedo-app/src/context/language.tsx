...
const languageContextInput = {
  ...
  init: (props: { locale?: Locale } = {}) => {
    ...
    const dict = createMemo<Dictionary>(() => {
      const current = locale()
      return { ...loaded(), ...(ext.app.strings?.[current] ?? {}) }
    })
...
export const { use: useLanguage, provider: LanguageProvider } = createSimpleContext<ReturnType<typeof languageContextInput.init>, { locale?: Locale }>(languageContextInput)
