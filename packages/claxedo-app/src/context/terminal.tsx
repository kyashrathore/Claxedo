...
import { scopeUrl } from "@claxedo/utils/url"
import { clearInitialCommandMarker } from "@claxedo/terminal/terminal-recovery"
import { mergeCreatedTerminal, type LocalPTY } from "@claxedo/context/terminal-shared"
import { legacyDirectoryFromRouteKey } from "@claxedo/shell/identity/route"
import { legacyTerminalPersistScopeKey, terminalScopeKey } from "@claxedo/shell/identity/session-view-key"
import { useClaxedoEventsOptional } from "@claxedo/context/claxedo-events"
import { authFetch, getClaxedoServerUrl } from "@claxedo/utils/api"
import { usePlatform } from "@claxedo/context/platform"
import { resolveWorkspaceRuntime } from "@claxedo/cloud/workspace-runtime-store"
import { sessionWorkspaceRuntimeRef } from "@claxedo/shell/workspace/session-workspace-key"
...
async function ptyResponse<T>(res: Response): Promise<T> {
  ...
  throw new Error(text || `PTY request failed: ${res.status}`)
}
