export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Claxedo",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Claxedo. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.error.serverStartFailed.title": "Nie udało się uruchomić Claxedo",
  "desktop.error.serverStartFailed.description":
    "Nie udało się uruchomić lokalnego serwera Claxedo. Uruchom ponownie aplikację lub sprawdź ustawienia sieciowe (VPN/proxy) i spróbuj ponownie.",
}
