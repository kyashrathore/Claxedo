export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de Claxedo",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de Claxedo a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.error.serverStartFailed.title": "Échec du démarrage de Claxedo",
  "desktop.error.serverStartFailed.description":
    "Impossible de démarrer le serveur Claxedo local. Redémarrez l'application ou vérifiez vos paramètres réseau (VPN/proxy) et réessayez.",
}
