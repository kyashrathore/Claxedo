export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 Claxedo",
  ...
  "desktop.updater.downloaded.prompt": "已下載 Claxedo {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.error.serverStartFailed.title": "Claxedo 啟動失敗",
  "desktop.error.serverStartFailed.description":
    "無法啟動本地 Claxedo 伺服器。請重新啟動應用程式，或檢查網路設定 (VPN/proxy) 後再試一次。",
}
