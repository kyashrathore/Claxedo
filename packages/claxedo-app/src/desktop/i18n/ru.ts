export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Claxedo",
  ...
  "desktop.updater.downloaded.prompt": "Версия Claxedo {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.error.serverStartFailed.title": "Не удалось запустить Claxedo",
  "desktop.error.serverStartFailed.description":
    "Не удалось запустить локальный сервер Claxedo. Перезапустите приложение или проверьте настройки сети (VPN/proxy) и попробуйте снова.",
}
