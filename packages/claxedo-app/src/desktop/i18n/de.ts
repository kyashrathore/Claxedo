export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Claxedo",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Claxedo wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.error.serverStartFailed.title": "Claxedo konnte nicht gestartet werden",
  "desktop.error.serverStartFailed.description":
    "Der lokale Claxedo-Server konnte nicht gestartet werden. Starten Sie die App neu oder überprüfen Sie Ihre Netzwerkeinstellungen (VPN/Proxy) und versuchen Sie es erneut.",
}
