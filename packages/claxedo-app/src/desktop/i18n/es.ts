export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Claxedo",
  ...
  "desktop.error.serverStartFailed.description":
    "No se pudo iniciar el servidor local de Claxedo. Reinicia la aplicación o revisa tu configuración de red (VPN/proxy) y vuelve a intentarlo.",
}
