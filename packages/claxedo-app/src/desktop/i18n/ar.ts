export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Claxedo",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Claxedo، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.error.serverStartFailed.title": "فشل تشغيل Claxedo",
  "desktop.error.serverStartFailed.description":
    "تعذر بدء تشغيل خادم Claxedo المحلي. أعد تشغيل التطبيق، أو تحقق من إعدادات الشبكة (VPN/proxy) وحاول مرة أخرى.",
}
