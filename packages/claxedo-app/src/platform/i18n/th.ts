export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "ใส่คีย์ API ของ {{vendor}} เพื่อรัน {{harness}} ด้วยบัญชีนี้",
  "provider.connect.apiKey.description.engine": "ใส่คีย์ API ของ {{vendor}} เพื่อใช้โมเดล {{vendor}} ใน {{engine}}",
  ...
  "provider.connect.token.description": "รันคำสั่งด้านล่างในเทอร์มินัลแล้ววางโทเค็นที่แสดง โทเค็นการสมัครใช้งานมีอายุประมาณหนึ่งปี",
  ...
  "provider.connect.oauth.description.harness": "ลงชื่อเข้าใช้ด้วย {{method}} Claxedo จะเก็บโทเคนไว้และใช้รัน {{harness}}",
  "provider.connect.oauth.description.engine": "ลงชื่อเข้าใช้ด้วย {{method}} Claxedo จะเก็บโทเคนที่ได้รับและใช้กับ {{vendor}} ใน {{engine}}",
  ...
  "sidebar.workspace.role.viewer": "ผู้อ่าน",
  "sidebar.workspace.role.editor": "ผู้แก้ไข",
  ...
  "settings.providers.agents.checking": "กำลังตรวจสอบ…",
  ...
  "settings.providers.agents.addAnotherAccount": "+ เพิ่มบัญชีอื่น",
  "settings.providers.agents.addFirstAccount": "เพิ่มบัญชี",
  ...
  "settings.providers.live.checkedAt": "ตรวจสอบ{{when}}",
  "settings.providers.live.checkedNow": "ตรวจสอบเมื่อสักครู่",
