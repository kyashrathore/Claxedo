export const dict = {
  ...
  "settings.providers.agents.scanning": "กำลังสแกนคอมพิวเตอร์เครื่องนี้…",
  ...
  "settings.providers.agents.machineSource": "จาก {{origin}}",
  ...
  "settings.providers.live.broken": "ใช้งานไม่ได้",
  "settings.providers.live.unknown": "ตรวจสอบไม่ได้",
  "settings.providers.live.missing": "ไม่พบการเข้าสู่ระบบ",
