export const dict = {
  ...
  "dialog.deeplink.open.title": "เปิดโฟลเดอร์นี้เป็นโปรเจกต์หรือไม่",
  "dialog.deeplink.open.body": "ลิงก์ที่เปิดจากภายนอก Claxedo ขอเพิ่มโฟลเดอร์นี้ลงในโปรเจกต์ของคุณ:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "ลิงก์นี้ยังมีข้อความพรอมต์ต่อไปนี้ด้วย:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "เปิด",
  ...
  "provider.connect.changeMethod": "เปลี่ยน",
  ...
  "settings.models.group.count": "{{enabled}} จาก {{total}}",
  "settings.models.group.enableAll": "เปิดทั้งหมด",
  "settings.models.group.disableAll": "ปิดทั้งหมด",
  "settings.models.tab.accounts": "บัญชี",
  "settings.models.tab.models": "โมเดล",
  "settings.models.accounts.connection": "{{harness}} ทำงานผ่านการเชื่อมต่อที่ตั้งค่าไว้",
  "settings.models.group.expand": "แสดงโมเดลของ {{provider}}",
