export const dict = {
  ...
  "settings.providers.agents.check": "ตรวจสอบ",
  "settings.providers.agents.checking": "กำลังตรวจสอบ…",
  "settings.providers.agents.accountActive": "ใช้งานอยู่",
  ...
  "settings.providers.agents.accountExpires": "หมดอายุ {{when}}",
  "settings.providers.agents.switchLater": "การสลับบัญชี Codex จะมาในภายหลัง",
