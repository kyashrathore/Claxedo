export const dict = {
  ...
  "provider.connect.token.label": "โทเค็นการสมัครใช้งาน {{provider}}",
  "provider.connect.token.placeholder": "โทเค็นการสมัครใช้งาน",
  "provider.connect.token.command": "คำสั่งเทอร์มินัล",
  "provider.connect.oauth.description": "ลงชื่อเข้าใช้ด้วย {{method}} Claxedo จะเก็บโทเค็นที่ได้รับและใช้กับ {{provider}}",
  ...
  "settings.providers.agents.checkNow": "ตรวจสอบตอนนี้",
  ...
  "settings.providers.agents.notSetUp": "ยังไม่ได้ตั้งค่า",
  "settings.providers.agents.usingAccount": "กำลังใช้ {{label}}",
  "settings.providers.agents.usingMachine": "กำลังใช้การเข้าสู่ระบบของคอมพิวเตอร์เครื่องนี้",
  "settings.providers.agents.headerRejected": "{{vendor}} ปฏิเสธ {{label}} เชื่อมต่ออีกครั้งหรือเลือกบัญชีอื่น",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}} เชื่อมต่ออีกครั้งหรือเลือกบัญชีอื่น",
  ...
  "settings.providers.agents.unchecked": "ยังไม่ได้ตรวจสอบ",
  "settings.providers.agents.accountMenu": "การดำเนินการสำหรับ {{account}}",
