export const dict = {
  ...
  "settings.providers.agents.checkNow": "Verificar agora",
  ...
  "settings.providers.agents.notSetUp": "Não configurado",
  "settings.providers.agents.usingAccount": "Usando {{label}}",
  "settings.providers.agents.usingMachine": "Usando o login deste computador",
  "settings.providers.agents.headerRejected": "{{label}} foi rejeitada por {{vendor}}. Reconecte ou escolha outra conta.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Reconecte ou escolha outra conta.",
  "settings.providers.agents.machineLogin": "Login deste computador",
  "settings.providers.agents.machineSource": "de {{origin}}",
  "settings.providers.agents.unchecked": "Não verificado",
  "settings.providers.agents.accountMenu": "Ações para {{account}}",
