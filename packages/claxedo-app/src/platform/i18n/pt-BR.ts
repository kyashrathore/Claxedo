export const dict = {
  ...
  "settings.providers.agents.inUse": "Em uso: {{label}}",
  "settings.providers.agents.inUseMachine": "Em uso: o login deste computador",
  "settings.providers.agents.check": "Verificar",
  "settings.providers.agents.checking": "Verificando…",
  "settings.providers.agents.accountActive": "Ativa",
  "settings.providers.agents.makeActive": "Tornar ativa",
  "settings.providers.agents.makingActive": "Alternando…",
  "settings.providers.agents.addAccount": "Adicionar conta",
  ...
  "settings.providers.agents.accountExpires": "Expira {{when}}",
  "settings.providers.agents.switchLater": "A troca de contas do Codex chegará depois.",
