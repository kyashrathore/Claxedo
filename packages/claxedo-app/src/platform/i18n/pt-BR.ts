export const dict = {
  ...
  "settings.providers.agents.scanning": "Examinando este computador…",
  ...
  "settings.providers.agents.machineSource": "de {{origin}}",
  ...
  "settings.providers.live.broken": "Não funciona",
  "settings.providers.live.unknown": "Não foi possível verificar",
  "settings.providers.live.missing": "Nenhum login encontrado",
