export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Insira sua chave de API da {{vendor}} para executar o {{harness}} nesta conta.",
  "provider.connect.apiKey.description.engine": "Insira sua chave de API da {{vendor}} para usar modelos da {{vendor}} no {{engine}}.",
  ...
  "provider.connect.oauth.description.harness": "Entre com {{method}}. O Claxedo guarda o token e executa o {{harness}} com ele.",
  "provider.connect.oauth.description.engine": "Entre com {{method}}. O Claxedo guarda o token recebido e o usa para a {{vendor}} no {{engine}}.",
  ...
  "settings.providers.agents.checking": "Verificando…",
  ...
  "settings.providers.agents.addAnotherAccount": "+ Adicionar outra conta",
  "settings.providers.agents.addFirstAccount": "Adicionar uma conta",
  ...
  "settings.providers.live.checkedAt": "Verificado {{when}}",
  "settings.providers.live.checkedNow": "Verificado agora mesmo",
