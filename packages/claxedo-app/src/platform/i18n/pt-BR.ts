export const dict = {
  ...
  "dialog.deeplink.open.title": "Abrir esta pasta como um projeto?",
  "dialog.deeplink.open.body": "Um link aberto fora do Claxedo pediu para adicionar esta pasta aos seus projetos:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "O link também traz este texto de prompt:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "Abrir",
  ...
  "provider.connect.changeMethod": "Alterar",
  ...
  "settings.models.group.count": "{{enabled}} de {{total}}",
  "settings.models.group.enableAll": "Ativar todos",
  "settings.models.group.disableAll": "Desativar todos",
  "settings.models.tab.accounts": "Contas",
  "settings.models.tab.models": "Modelos",
  "settings.models.accounts.connection": "O {{harness}} usa a conexão com que foi configurado.",
  "settings.models.group.expand": "Mostrar modelos da {{provider}}",
