export const dict = {
  ...
  "settings.general.row.shell.description":
    "Escolha o shell usado no seu terminal. Shells compatíveis também são usados nas chamadas de ferramentas do agente.",
  ...
  "settings.general.row.showFileTree.description":
    "Mostrar o alternador e o painel da árvore de arquivos em sessões desktop",
  ...
  "workspace.creating": "Criando espaço de trabalho...",
  ...
  "settings.providers.search.placeholder": "Pesquisar provedores OpenCode…",
