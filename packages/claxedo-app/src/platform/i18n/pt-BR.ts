export const dict = {
  ...
  "navigator.sidebar.tab.files": "Arquivos",
  "navigator.sidebar.tab.changes": "Alterações",
  "navigator.sidebar.tab.processes": "Processos",
  "navigator.sidebar.empty": "Selecione um espaço de trabalho para usar o navegador.",
  "navigator.sidebar.resize": "Redimensionar o navegador",
  ...
  "settings.scope.harness.label": "Agente",
  ...
  "settings.general.row.navigatorPlacement.title": "Posição do navegador",
  "settings.general.row.navigatorPlacement.description": "Mostre o navegador de arquivos, alterações e processos dentro do painel do espaço de trabalho ou como barra lateral ao lado da lista de projetos",
  "settings.general.row.navigatorPlacement.option.panel": "Painel do espaço de trabalho",
