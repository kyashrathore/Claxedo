export const dict = {
  ...
  "provider.connect.selectMethod": "Selecionar método de login para {{vendor}}.",
  "provider.connect.status.inProgress": "Autorização em andamento...",
  "provider.connect.status.waiting": "Aguardando autorização...",
  "provider.connect.apiKey.label": "Chave de API do {{vendor}}",
  "provider.connect.apiKey.placeholder": "Chave de API",
  "provider.connect.apiKey.required": "A chave de API é obrigatória",
  "provider.connect.label.label": "Rótulo",
  "provider.connect.label.placeholder": "name@company.com ou um nome que você reconheça",
  "provider.connect.label.required": "Adicione um rótulo para reconhecer esta conta",
  "provider.connect.token.label": "Token de assinatura do {{vendor}}",
  ...
  "provider.connect.oauth.code.visit.suffix.engine": " para obter seu código de autorização e usar modelos da {{vendor}} no {{engine}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix.harness": " e insira o código abaixo para executar o {{harness}} nesta conta.",
  "provider.connect.oauth.auto.visit.suffix.engine": " e insira o código abaixo para usar modelos da {{vendor}} no {{engine}}.",
  ...
  "provider.connect.toast.connected.description.harness": "O {{harness}} agora roda nesta conta.",
  "provider.connect.toast.connected.description.engine": "Os modelos da {{vendor}} agora estão disponíveis no {{engine}}.",
  ...
  "common.lastChecked": "Verificado pela última vez {{ago}}",
  ...
  "prompt.toast.attachmentHarnessUnsupported.description":
    "{{harness}} não tem uma entrada de prompt para {{mime}}, e esta sessão não tem uma pasta de espaço de trabalho para guardar o arquivo.",
  ...
  "home.empty.description": "Comece abrindo uma pasta deste computador",
  "home.title": "Início",
  ...
  "settings.providers.agents.checkAccount": "Verificar",
  "settings.providers.agents.scanning": "Verificando este computador…",
  "settings.providers.agents.rescanning": "Verificando…",
  "settings.providers.agents.scanFailed": "Não foi possível ler este computador",
  "settings.providers.agents.scannedNow": "Examinado agora mesmo",
  "settings.providers.agents.scannedAt": "Examinado {{when}}",
  "settings.providers.agents.rescan": "Examinar novamente",
  "settings.providers.agents.machineLogin": "Login deste computador",
  "settings.providers.agents.addAccount": "Adicionar uma conta",
  "settings.providers.agents.machinePlan": "Plano {{plan}}",
  "settings.providers.agents.machineSignedOut": "Sem login — execute {{command}}",
  "settings.providers.agents.machineNotInstalled": "Não instalado",
  ...
  "settings.providers.agents.reconnectAccount": "Reconectar",
  "settings.providers.agents.removeAccount": "Remover",
  "settings.providers.agents.removeAccountConfirm": "Remover a conta?",
  "settings.providers.agents.removingAccount": "Removendo…",
  "settings.providers.live.ok": "Funcionando",
  "settings.providers.live.authFailed": "Rejeitado pelo provedor",
  "settings.providers.live.noBilling": "Sem cobrança ativa",
  "settings.providers.live.rateCapped": "Limite atingido",
  "settings.providers.live.expired": "Expirado",
  "settings.providers.live.unknown": "Não foi possível verificar",
  "settings.providers.live.window": "{{name}} {{used}}% usado",
  "settings.providers.window.session": "Sessão",
  "settings.providers.window.weekly": "Semanal",
  "settings.providers.window.weeklyOpus": "Semanal · Opus",
  "usage.quota.notChecked": "Ainda não verificado",
  ...
  "usage.quota.kicker": "Das suas contas conectadas",
  "usage.quota.title": "Janelas de cota",
  "usage.quota.empty": "Nenhuma conta conectada informa um plano aqui.",
  "usage.quota.inUse": "Em uso",
  "usage.quota.windowLeft": "Resta {{percent}}%",
  "usage.quota.windowResets": "redefine em {{reset}}",
  "usage.quota.windowUsed": "{{account}} {{window}}: {{percent}}% usado",
  "usage.quota.resetNow": "agora",
  "settings.providers.connect.subtitle": "Salvo para {{provider}} neste computador. Esc fecha sem salvar.",
  "settings.providers.connect.reconnectTitle": "Reconectar {{provider}}",
  "settings.providers.connect.reconnectSubtitle": "Substitui o token desta conta, mantendo o nome e o lugar dela na lista. Esc fecha sem salvar.",
  ...
  "session.question.collapse": "Recolher pergunta",
  "session.question.expand": "Expandir pergunta",
