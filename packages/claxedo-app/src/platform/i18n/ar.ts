export const dict = {
  ...
  "common.cancel": "إلغاء",
  "common.justNow": "الآن",
  "common.lastChecked": "آخر فحص {{ago}}",
  ...
  "prompt.toast.attachmentHarnessUnsupported.description":
    "لا يوجد في {{harness}} مدخل مطالبة لـ {{mime}}، وهذه الجلسة لا تحتوي على مجلد مساحة عمل لحفظ الملف.",
  ...
  "home.empty.description": "ابدأ بفتح مجلد من هذا الكمبيوتر",
  "home.title": "الرئيسية",
  ...
  "settings.providers.agents.scanning": "جارٍ فحص هذا الجهاز…",
  "settings.providers.agents.rescanning": "جارٍ الفحص…",
  "settings.providers.agents.scanFailed": "تعذّرت قراءة هذا الجهاز",
  ...
  "settings.providers.agents.addAccount": "أضف حسابًا",
  "settings.providers.agents.machinePlan": "اشتراك {{plan}}",
  "settings.providers.agents.machineSignedOut": "لم يتم تسجيل الدخول — شغّل {{command}}",
  "settings.providers.agents.machineNotInstalled": "غير مثبّت",
  ...
  "usage.quota.kicker": "من حساباتك المتصلة",
  "usage.quota.title": "نوافذ الحصة",
  "usage.quota.empty": "لا يبلّغ أي حساب متصل عن خطة هنا.",
  "usage.quota.inUse": "قيد الاستخدام",
  "usage.quota.windowLeft": "تبقّى {{percent}}%",
  "usage.quota.windowResets": "يعود خلال {{reset}}",
  "usage.quota.windowUsed": "{{account}} {{window}}: {{percent}}% مستخدَم",
  "usage.quota.resetNow": "الآن",
