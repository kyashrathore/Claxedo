export const dict = {
  ...
  "settings.providers.agents.check": "فحص",
  "settings.providers.agents.checking": "جارٍ الفحص…",
  "settings.providers.agents.accountActive": "نشط",
  ...
  "settings.providers.agents.accountExpires": "تنتهي الصلاحية {{when}}",
  "settings.providers.agents.switchLater": "سيصل تبديل حسابات Codex لاحقًا.",
  ...
  "settings.providers.status.detected": "تم اكتشافه",
  "settings.providers.status.broken": "يتطلب انتباهًا",
