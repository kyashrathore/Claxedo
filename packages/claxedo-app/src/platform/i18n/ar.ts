export const dict = {
  ...
  "session.review.noUncommittedChanges": "لا توجد تغييرات غير مرحّلة بعد",
  ...
  "settings.general.row.shell.title": "قشرة الطرفية",
  "settings.general.row.shell.description":
    "اختر القشرة (shell) المستخدمة لطرفيتك. تُستخدم القشرات المتوافقة أيضًا في استدعاءات أدوات الوكيل.",
  ...
  "workspace.creating": "جارٍ إنشاء مساحة العمل...",
  ...
  "settings.models.showMore": "عرض المزيد",
  "settings.models.showLess": "عرض أقل",
  "settings.models.previewCount": "عرض {{count}} إضافية",
