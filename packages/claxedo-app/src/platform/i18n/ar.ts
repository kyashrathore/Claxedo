export const dict = {
  ...
  "dialog.deeplink.open.title": "فتح هذا المجلد كمشروع؟",
  "dialog.deeplink.open.body": "طلب رابط من خارج Claxedo إضافة هذا المجلد إلى مشاريعك:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "يحمل الرابط أيضًا نص المطالبة التالي:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "فتح",
  ...
  "provider.connect.changeMethod": "تغيير",
  ...
  "settings.models.group.count": "{{enabled}} من {{total}}",
  "settings.models.group.enableAll": "تفعيل الكل",
  "settings.models.group.disableAll": "تعطيل الكل",
  "settings.models.tab.accounts": "الحسابات",
  "settings.models.tab.models": "النماذج",
  "settings.models.accounts.connection": "يعمل {{harness}} على الاتصال الذي تم إعداده به.",
  "settings.models.group.expand": "عرض نماذج {{provider}}",
