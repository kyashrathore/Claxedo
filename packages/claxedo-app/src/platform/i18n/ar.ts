export const dict = {
  ...
  "provider.connect.token.label": "رمز اشتراك {{provider}}",
  "provider.connect.token.placeholder": "رمز الاشتراك",
  "provider.connect.token.command": "أمر الطرفية",
  "provider.connect.oauth.description": "سجّل الدخول عبر {{method}}. يحتفظ Claxedo بالرمز الذي يتلقاه ويستخدمه مع {{provider}}.",
  ...
  "settings.providers.agents.checkNow": "افحص الآن",
  ...
  "settings.providers.agents.notSetUp": "غير مُعد",
  "settings.providers.agents.usingAccount": "يستخدم {{label}}",
  "settings.providers.agents.usingMachine": "يستخدم تسجيل الدخول على هذا الجهاز",
  "settings.providers.agents.headerRejected": "رفض {{vendor}} الحساب {{label}}. أعد الاتصال أو اختر حسابًا آخر.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. أعد الاتصال أو اختر حسابًا آخر.",
  "settings.providers.agents.machineLogin": "تسجيل الدخول على هذا الجهاز",
  "settings.providers.agents.machineSource": "من {{origin}}",
  "settings.providers.agents.unchecked": "لم يُفحص",
  "settings.providers.agents.accountMenu": "إجراءات {{account}}",
  "settings.providers.agents.addAnotherAccount": "+ إضافة حساب آخر",
  "settings.providers.agents.addFirstAccount": "+ إضافة حساب",
