export const dict = {
  ...
  "settings.general.row.navigatorPlacement.title": "موضع المتصفح",
  "settings.general.row.navigatorPlacement.description": "اعرض متصفح الملفات والتغييرات والعمليات داخل لوحة مساحة العمل أو كشريط جانبي بجوار قائمة المشاريع",
  "settings.general.row.navigatorPlacement.option.panel": "لوحة مساحة العمل",
  "settings.general.row.navigatorPlacement.option.sidebar": "الشريط الجانبي",
