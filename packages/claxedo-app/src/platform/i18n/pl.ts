export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Wprowadź swój klucz API {{vendor}}, aby uruchomić {{harness}} na tym koncie.",
  "provider.connect.apiKey.description.engine": "Wprowadź swój klucz API {{vendor}}, aby używać modeli {{vendor}} w {{engine}}.",
  ...
  "provider.connect.oauth.description.harness": "Zaloguj się przez {{method}}. Claxedo zachowuje token i uruchamia z nim {{harness}}.",
  "provider.connect.oauth.description.engine": "Zaloguj się przez {{method}}. Claxedo zachowuje otrzymany token i używa go dla {{vendor}} w {{engine}}.",
  ...
  "settings.providers.agents.machineSource": "z {{origin}}",
  "settings.providers.agents.addAnotherAccount": "+ Dodaj kolejne konto",
  "settings.providers.agents.addFirstAccount": "Dodaj konto",
  ...
  "settings.providers.live.broken": "Nie działa",
  "settings.providers.live.unknown": "Nie udało się sprawdzić",
  "settings.providers.live.missing": "Nie znaleziono logowania",
  "settings.providers.live.window": "{{name}} zużyto {{used}}%",
  "settings.providers.live.checkedAt": "Sprawdzono {{when}}",
  "settings.providers.live.checkedNow": "Sprawdzono przed chwilą",
