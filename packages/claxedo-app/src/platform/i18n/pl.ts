export const dict = {
  ...
  "settings.general.row.shell.description":
    "Wybierz powłokę używaną w terminalu. Kompatybilne powłoki są też używane do wywołań narzędzi agenta.",
  ...
  "settings.general.row.pinchZoom.title": "Powiększanie szczypaniem",
  "settings.general.row.pinchZoom.description":
    "Zezwól na gesty szczypania na touchpadzie i Ctrl-scroll do powiększania",
  ...
  "workspace.creating": "Tworzenie przestrzeni roboczej...",
