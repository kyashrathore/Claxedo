export const dict = {
  ...
  "settings.providers.agents.checkNow": "Sprawdź teraz",
  ...
  "settings.providers.agents.notSetUp": "Nieskonfigurowane",
  "settings.providers.agents.usingAccount": "Używa {{label}}",
  "settings.providers.agents.usingMachine": "Używa logowania na tym komputerze",
  "settings.providers.agents.headerRejected": "{{vendor}} odrzucił konto {{label}}. Połącz ponownie lub wybierz inne konto.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Połącz ponownie lub wybierz inne konto.",
  "settings.providers.agents.machineLogin": "Logowanie na tym komputerze",
  "settings.providers.agents.machineSource": "z {{origin}}",
  "settings.providers.agents.unchecked": "Niesprawdzone",
  "settings.providers.agents.accountMenu": "Działania dla {{account}}",
