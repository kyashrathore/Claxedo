export const dict = {
  ...
  "provider.connect.apiKey.label": "Klucz API {{vendor}}",
  "provider.connect.apiKey.placeholder": "Klucz API",
  "provider.connect.apiKey.required": "Klucz API jest wymagany",
  "provider.connect.label.label": "Etykieta",
  "provider.connect.label.placeholder": "name@company.com lub nazwa, którą rozpoznasz",
  "provider.connect.label.required": "Dodaj etykietę, aby rozpoznać to konto",
  "provider.connect.token.label": "Token subskrypcji {{vendor}}",
  ...
  "provider.connect.oauth.code.visit.suffix.engine": ", aby pobrać kod autoryzacji i używać modeli {{vendor}} w {{engine}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix.harness": " i wprowadź poniższy kod, aby uruchomić {{harness}} na tym koncie.",
  "provider.connect.oauth.auto.visit.suffix.engine": " i wprowadź poniższy kod, aby używać modeli {{vendor}} w {{engine}}.",
  "provider.connect.oauth.auto.confirmationCode": "Kod potwierdzający",
  "provider.connect.toast.connected.title": "Połączono {{vendor}}",
  "provider.connect.toast.connected.description.harness": "{{harness}} działa teraz na tym koncie.",
  "provider.connect.toast.connected.description.engine": "Modele {{vendor}} są teraz dostępne w {{engine}}.",
  ...
  "common.lastChecked": "Ostatnio sprawdzono {{ago}}",
  ...
  "prompt.toast.attachmentHarnessUnsupported.description":
    "{{harness}} nie ma wejścia promptu dla {{mime}}, a ta sesja nie ma folderu przestrzeni roboczej, w którym plik mógłby pozostać.",
  ...
  "home.empty.description": "Zacznij od otwarcia folderu z tego komputera",
  ...
  "settings.providers.agents.machineLogin": "Logowanie na tym komputerze",
  "settings.providers.agents.addAccount": "Dodaj konto",
  ...
  "settings.providers.agents.reconnectAccount": "Połącz ponownie",
  "settings.providers.agents.removeAccount": "Usuń",
  "settings.providers.agents.removeAccountConfirm": "Usunąć konto?",
  "settings.providers.agents.removingAccount": "Usuwanie…",
  "settings.providers.live.ok": "Działa",
  "settings.providers.live.authFailed": "Odrzucone przez dostawcę",
  "settings.providers.live.noBilling": "Brak aktywnych rozliczeń",
  "settings.providers.live.rateCapped": "Osiągnięto limit",
  "settings.providers.live.expired": "Wygasło",
  "settings.providers.live.unknown": "Nie udało się sprawdzić",
  "settings.providers.live.window": "{{name}} zużyto {{used}}%",
  ...
  "usage.quota.otherAgents": "Inni agenci na tym komputerze",
  "usage.quota.throttled": "Odświeżono {{ago}} temu · następne odświeżenie za {{wait}}",
  "usage.quota.summary": "Pozostało {{percent}}% w {{window}}",
  "usage.quota.summaryForAccount": "Pozostało {{percent}}% w {{window}} dla {{account}}",
  "usage.quota.summaryReset": "{{summary}}, reset za {{reset}}",
  "usage.quota.kicker": "Z Twoich połączonych kont",
  "usage.quota.title": "Okna limitu",
  "usage.quota.empty": "Żadne połączone konto nie zgłasza tutaj planu.",
  "usage.quota.inUse": "W użyciu",
  "usage.quota.windowLeft": "Pozostało {{percent}}%",
  "usage.quota.windowResets": "reset za {{reset}}",
  "usage.quota.windowUsed": "{{account}} {{window}}: zużyto {{percent}}%",
  "usage.quota.resetNow": "teraz",
  "settings.providers.connect.subtitle": "Zapisane dla {{provider}} na tym komputerze. Esc zamyka bez zapisywania.",
  "settings.providers.connect.reconnectTitle": "Połącz ponownie {{provider}}",
  "settings.providers.connect.reconnectSubtitle": "Zastępuje token na tym koncie, zachowując jego nazwę i miejsce na liście. Esc zamyka bez zapisywania.",
  ...
  "session.question.collapse": "Zwiń pytanie",
  "session.question.expand": "Rozwiń pytanie",
