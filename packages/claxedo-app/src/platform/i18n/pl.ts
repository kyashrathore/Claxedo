export const dict = {
  ...
  "provider.connect.changeMethod": "Zmień",
  ...
  "settings.models.group.count": "{{enabled}} z {{total}}",
  "settings.models.group.enableAll": "Włącz wszystkie",
  "settings.models.group.disableAll": "Wyłącz wszystkie",
  "settings.models.tab.accounts": "Konta",
  "settings.models.tab.models": "Modele",
  "settings.models.accounts.connection": "{{harness}} działa na połączeniu, z którym został skonfigurowany.",
  "settings.models.group.expand": "Pokaż modele {{provider}}",
