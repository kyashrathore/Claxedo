export const dict = {
  ...
  "dialog.deeplink.open.title": "Otworzyć ten folder jako projekt?",
  "dialog.deeplink.open.body": "Link otwarty poza Claxedo poprosił o dodanie tego folderu do Twoich projektów:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "Link zawiera również ten tekst promptu:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "Otwórz",
