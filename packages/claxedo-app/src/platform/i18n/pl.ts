export const dict = {
  ...
  "navigator.sidebar.tab.files": "Pliki",
  "navigator.sidebar.tab.changes": "Zmiany",
  "navigator.sidebar.tab.processes": "Procesy",
  "navigator.sidebar.empty": "Wybierz przestrzeń roboczą, aby użyć nawigatora.",
  "navigator.sidebar.resize": "Zmień rozmiar nawigatora",
  ...
  "settings.scope.harness.label": "Agent",
  ...
  "settings.general.row.navigatorPlacement.title": "Położenie nawigatora",
  "settings.general.row.navigatorPlacement.description": "Pokaż nawigator plików, zmian i procesów w panelu obszaru roboczego lub jako pasek boczny obok listy projektów",
  "settings.general.row.navigatorPlacement.option.panel": "Panel obszaru roboczego",
  "settings.general.row.navigatorPlacement.option.sidebar": "Pasek boczny",
