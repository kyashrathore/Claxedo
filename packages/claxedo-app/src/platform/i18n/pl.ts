export const dict = {
  ...
  "settings.providers.agents.check": "Sprawdź",
  "settings.providers.agents.checking": "Sprawdzanie…",
  "settings.providers.agents.accountActive": "Aktywne",
  "settings.providers.agents.makeActive": "Ustaw jako aktywne",
  "settings.providers.agents.makingActive": "Przełączanie…",
  ...
  "settings.providers.agents.accountExpires": "Wygasa {{when}}",
  "settings.providers.agents.switchLater": "Przełączanie kont Codex pojawi się później.",
