export const dict = {
  ...
  "settings.providers.agents.checkNow": "今すぐ確認",
  ...
  "settings.providers.agents.notSetUp": "未設定",
  "settings.providers.agents.usingAccount": "{{label}} を使用中",
  "settings.providers.agents.usingMachine": "このコンピューターのログインを使用中",
  "settings.providers.agents.headerRejected": "{{label}} は {{vendor}} に拒否されました。再接続するか、別のアカウントを選んでください。",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}。再接続するか、別のアカウントを選んでください。",
  "settings.providers.agents.machineLogin": "このコンピューターのログイン",
  "settings.providers.agents.machineSource": "{{origin}} から",
  "settings.providers.agents.unchecked": "未確認",
  "settings.providers.agents.accountMenu": "{{account}} の操作",
