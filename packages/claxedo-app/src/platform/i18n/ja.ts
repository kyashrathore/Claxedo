export const dict = {
  ...
  "session.review.noUncommittedChanges": "まだ未コミットの変更はありません",
  ...
  "settings.general.row.showStatus.description": "デスクトップのタイトルバーにサーバーステータスボタンを表示します",
  ...
  "settings.general.row.pinchZoom.description": "トラックパッドのピンチ操作とCtrl+スクロールによるズームを許可します",
  ...
  "workspace.creating": "ワークスペースを作成中...",
  ...
  "settings.models.showMore": "もっと見る",
  "settings.models.showLess": "表示を減らす",
  "settings.models.previewCount": "さらに {{count}} 件表示",
  ...
  "settings.providers.search.placeholder": "OpenCode プロバイダーを検索…",
