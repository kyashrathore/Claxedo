export const dict = {
  ...
  "provider.connect.label.label": "ラベル",
  "provider.connect.label.placeholder": "name@company.com など、見分けのつく名前",
  "provider.connect.label.required": "このアカウントを見分けられるようにラベルを入力してください",
  "provider.connect.token.label": "{{vendor}} サブスクリプショントークン",
  ...
  "provider.connect.oauth.code.visit.suffix.engine": " で認証コードを取得すると、{{engine}} で {{vendor}} のモデルを使えます。",
  ...
  "provider.connect.oauth.auto.visit.suffix.harness": " を開き、下のコードを入力すると、このアカウントで {{harness}} が動作します。",
  "provider.connect.oauth.auto.visit.suffix.engine": " を開き、下のコードを入力すると、{{engine}} で {{vendor}} のモデルを使えます。",
  "provider.connect.oauth.auto.confirmationCode": "確認コード",
  "provider.connect.toast.connected.title": "{{vendor}}が接続されました",
  "provider.connect.toast.connected.description.harness": "{{harness}} はこのアカウントで動作するようになりました。",
  "provider.connect.toast.connected.description.engine": "{{engine}} で {{vendor}} のモデルを使えるようになりました。",
  ...
  "prompt.toast.attachmentHarnessUnsupported.description":
    "{{harness}} には {{mime}} を渡す入力がなく、このセッションにはファイルを置くワークスペースフォルダもありません。",
  ...
  "home.empty.description": "このコンピュータのフォルダを開いて始めましょう",
  "home.title": "ホーム",
  ...
  "settings.providers.agents.checkAccount": "確認",
  "settings.providers.agents.scanning": "このマシンを確認中…",
  "settings.providers.agents.rescanning": "確認中…",
  "settings.providers.agents.scanFailed": "このマシンを読み取れませんでした",
  "settings.providers.agents.scannedNow": "たった今スキャン",
  "settings.providers.agents.scannedAt": "{{when}}にスキャン",
  "settings.providers.agents.rescan": "再スキャン",
  "settings.providers.agents.machineLogin": "このコンピューターのログイン",
  "settings.providers.agents.addAccount": "アカウントを追加",
  "settings.providers.agents.machinePlan": "{{plan}} プラン",
  ...
  "usage.quota.kicker": "接続済みアカウントから",
  "usage.quota.title": "クォータ期間",
  "usage.quota.empty": "プランを報告している接続済みアカウントはありません。",
  "usage.quota.inUse": "使用中",
  "usage.quota.windowLeft": "残り {{percent}}%",
  "usage.quota.windowResets": "{{reset}} 後にリセット",
  "usage.quota.windowUsed": "{{account}} {{window}}: {{percent}}% 使用",
  "usage.quota.resetNow": "今",
  "settings.providers.connect.subtitle": "このコンピューターの {{provider}} 用に保存されます。Esc で保存せずに閉じます。",
  "settings.providers.connect.reconnectTitle": "{{provider}} を再接続",
  "settings.providers.connect.reconnectSubtitle": "このアカウントのトークンを置き換えます。名前とリスト内の位置はそのままです。Esc で保存せずに閉じます。",
