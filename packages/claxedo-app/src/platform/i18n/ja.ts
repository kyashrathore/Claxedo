export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "{{vendor}} の API キーを入力すると、このアカウントで {{harness}} が動作します。",
  "provider.connect.apiKey.description.engine": "{{vendor}} の API キーを入力すると、{{engine}} で {{vendor}} のモデルを使えます。",
  ...
  "provider.connect.oauth.description.harness": "{{method}} でサインインします。Claxedo はトークンを保持し、それで {{harness}} を実行します。",
  "provider.connect.oauth.description.engine": "{{method}} でサインインします。Claxedo は受け取ったトークンを保持し、{{engine}} の {{vendor}} に使用します。",
  ...
  "settings.providers.agents.addAnotherAccount": "+ 別のアカウントを追加",
  "settings.providers.agents.addFirstAccount": "アカウントを追加",
