export const dict = {
  ...
  "dialog.deeplink.open.title": "このフォルダをプロジェクトとして開きますか？",
  "dialog.deeplink.open.body": "Claxedo の外部から開かれたリンクが、このフォルダをプロジェクトに追加するよう求めています:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "このリンクには次のプロンプト本文も含まれています:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "開く",
  ...
  "provider.connect.changeMethod": "変更",
  ...
  "settings.models.group.count": "{{total}} 件中 {{enabled}} 件",
  "settings.models.group.enableAll": "すべて有効化",
  "settings.models.group.disableAll": "すべて無効化",
  "settings.models.tab.accounts": "アカウント",
  "settings.models.tab.models": "モデル",
  "settings.models.accounts.connection": "{{harness}} は設定時の接続で動作します。",
  "settings.models.group.expand": "{{provider}} のモデルを表示",
