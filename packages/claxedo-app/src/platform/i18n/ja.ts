export const dict = {
  ...
  "settings.models.providerSearch.hint": "{{total}} 件中、最初の {{shown}} 件を表示しています。検索して他を探してください。",
  "settings.models.providerSearch.placeholder": "{{provider}} のモデルを検索…",
  "settings.models.showLess": "表示を減らす",
  "settings.models.showMore": "さらに表示",
  "settings.providers.agents.sharedCredential": "1 回の設定で ACP とネイティブ SDK を利用できます。",
  "settings.providers.detect.action": "認証情報を検出",
  "settings.providers.detect.description": "このコンピューターで Claude、Codex、Cursor のログインをスキャンし、下の状態を更新します。",
  "settings.providers.detect.running": "検出中…",
  "settings.providers.pi.description": "Pi は Anthropic、OpenAI、OpenAI Codex をサポートしています。",
  "settings.providers.search.label": "プロバイダーを検索",
  "settings.providers.search.placeholder": "OpenCode プロバイダーを検索…",
  "settings.providers.section.agents": "このコンピューターのエージェント",
