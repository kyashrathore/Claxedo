export const dict = {
  ...
  "settings.general.row.navigatorPlacement.title": "ナビゲーターの配置",
  "settings.general.row.navigatorPlacement.description": "ファイル・変更・プロセスのナビゲーターをワークスペースパネル内に表示するか、プロジェクト一覧の横にサイドバーとして表示するかを選択します",
  "settings.general.row.navigatorPlacement.option.panel": "ワークスペースパネル",
  "settings.general.row.navigatorPlacement.option.sidebar": "サイドバー",
