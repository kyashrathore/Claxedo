...
export const dict = {
  ...
  "settings.providers.agents.check": "Kontrol et",
  "settings.providers.agents.checking": "Kontrol ediliyor…",
  "settings.providers.agents.accountActive": "Etkin",
  ...
  "settings.providers.agents.accountExpires": "{{when}} sona eriyor",
  "settings.providers.agents.switchLater": "Codex hesapları arasında geçiş daha sonra gelecek.",
