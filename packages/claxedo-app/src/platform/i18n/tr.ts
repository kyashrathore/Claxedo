...
export const dict = {
  ...
  "settings.models.providerSearch.hint": "{{total}} modelden ilk {{shown}} tanesi gösteriliyor. Diğerlerini bulmak için arayın.",
  ...
  "settings.providers.detect.description": "Bu bilgisayarda Claude, Codex ve Cursor oturum açmalarını tarar, ardından aşağıdaki durumu günceller.",
