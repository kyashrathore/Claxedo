...
export const dict = {
  ...
  "common.lastChecked": "Son kontrol {{ago}}",
  ...
  "usage.quota.kicker": "Bağlı hesaplarınızdan",
  ...
  "usage.quota.windowLeft": "%{{percent}} kaldı",
  "usage.quota.windowResets": "{{reset}} sonra sıfırlanır",
  "usage.quota.windowUsed": "{{account}} {{window}}: %{{percent}} kullanıldı",
  "usage.quota.resetNow": "şimdi",
