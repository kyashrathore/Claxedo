...
export const dict = {
  ...
  "provider.connect.token.label": "{{provider}} abonelik belirteci",
  "provider.connect.token.placeholder": "Abonelik belirteci",
  "provider.connect.token.command": "Terminal komutu",
  "provider.connect.oauth.description": "{{method}} ile oturum açın. Claxedo aldığı belirteci saklar ve {{provider}} için kullanır.",
  ...
  "settings.providers.agents.checkNow": "Şimdi kontrol et",
  ...
  "settings.providers.agents.notSetUp": "Kurulmadı",
  "settings.providers.agents.usingAccount": "{{label}} kullanılıyor",
  "settings.providers.agents.usingMachine": "Bu bilgisayarın oturumu kullanılıyor",
  "settings.providers.agents.headerRejected": "{{label}}, {{vendor}} tarafından reddedildi. Yeniden bağlanın veya başka bir hesap seçin.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Yeniden bağlanın veya başka bir hesap seçin.",
  "settings.providers.agents.machineLogin": "Bu bilgisayarın oturumu",
  "settings.providers.agents.machineSource": "{{origin}} konumundan",
  "settings.providers.agents.unchecked": "Kontrol edilmedi",
  "settings.providers.agents.accountMenu": "{{account}} için eylemler",
