...
export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "{{harness}} uygulamasını bu hesapla çalıştırmak için {{vendor}} API anahtarınızı girin.",
  "provider.connect.apiKey.description.engine": "{{engine}} içinde {{vendor}} modellerini kullanmak için {{vendor}} API anahtarınızı girin.",
  ...
  "provider.connect.token.description": "Aşağıdaki komutu bir terminalde çalıştırın ve yazdırdığı belirteci yapıştırın. Abonelik belirteci yaklaşık bir yıl geçerlidir.",
  ...
  "provider.connect.oauth.description.harness": "{{method}} ile oturum açın. Claxedo belirteci saklar ve {{harness}} uygulamasını onunla çalıştırır.",
  "provider.connect.oauth.description.engine": "{{method}} ile oturum açın. Claxedo aldığı belirteci saklar ve {{engine}} içindeki {{vendor}} için kullanır.",
  ...
  "settings.providers.agents.machineSource": "{{origin}} konumundan",
  "settings.providers.agents.addAnotherAccount": "+ Başka bir hesap ekle",
  "settings.providers.agents.addFirstAccount": "Hesap ekle",
  ...
  "settings.providers.live.broken": "Çalışmıyor",
  "settings.providers.live.unknown": "Kontrol edilemedi",
  "settings.providers.live.missing": "Giriş bulunamadı",
