...
export const dict = {
  ...
  "dialog.deeplink.open.title": "Bu klasör proje olarak açılsın mı?",
  "dialog.deeplink.open.body": "Claxedo dışından açılan bir bağlantı, bu klasörün projelerinize eklenmesini istedi:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "Bağlantı ayrıca şu istem metnini taşıyor:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "Aç",
  ...
  "provider.connect.changeMethod": "Değiştir",
  ...
  "settings.models.group.count": "{{total}} modelin {{enabled}} tanesi",
  "settings.models.group.enableAll": "Tümünü aç",
  "settings.models.group.disableAll": "Tümünü kapat",
  "settings.models.tab.accounts": "Hesaplar",
  "settings.models.tab.models": "Modeller",
  "settings.models.accounts.connection": "{{harness}}, kurulduğu bağlantı üzerinden çalışır.",
  "settings.models.group.expand": "{{provider}} modellerini göster",
