...
export const dict = {
  ...
  "settings.providers.agents.check": "Sjekk",
  ...
  "settings.providers.agents.accountExpires": "Utløper {{when}}",
  "settings.providers.agents.switchLater": "Bytte mellom Codex-kontoer kommer senere.",
