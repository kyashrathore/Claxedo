...
export const dict = {
  ...
  "provider.connect.oauth.description": "Logg inn med {{method}}. Claxedo beholder tokenet det mottar og bruker det for {{provider}}.",
  ...
  "settings.providers.agents.checkNow": "Sjekk nå",
  ...
  "settings.providers.agents.notSetUp": "Ikke satt opp",
  "settings.providers.agents.usingAccount": "Bruker {{label}}",
  "settings.providers.agents.usingMachine": "Bruker påloggingen på denne maskinen",
  "settings.providers.agents.headerRejected": "{{label}} ble avvist av {{vendor}}. Koble til på nytt, eller velg en annen konto.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Koble til på nytt, eller velg en annen konto.",
  "settings.providers.agents.machineLogin": "Påloggingen på denne maskinen",
  "settings.providers.agents.machineSource": "fra {{origin}}",
  "settings.providers.agents.unchecked": "Ikke sjekket",
