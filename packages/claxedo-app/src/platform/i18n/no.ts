...
export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Skriv inn {{vendor}}-API-nøkkelen din for å kjøre {{harness}} på denne kontoen.",
  "provider.connect.apiKey.description.engine": "Skriv inn {{vendor}}-API-nøkkelen din for å bruke {{vendor}}-modeller i {{engine}}.",
  ...
  "provider.connect.token.description": "Kjør kommandoen nedenfor i en terminal og lim inn tokenet den skriver ut. Et abonnementstoken varer i omtrent ett år.",
  ...
  "provider.connect.oauth.description.harness": "Logg inn med {{method}}. Claxedo beholder tokenet og kjører {{harness}} med det.",
  "provider.connect.oauth.description.engine": "Logg inn med {{method}}. Claxedo beholder tokenet det mottar og bruker det til {{vendor}} i {{engine}}.",
  ...
  "settings.providers.agents.addAnotherAccount": "+ Legg til en konto til",
  "settings.providers.agents.addFirstAccount": "Legg til en konto",
  ...
  "settings.providers.live.broken": "Fungerer ikke",
  "settings.providers.live.unknown": "Kunne ikke sjekke",
  "settings.providers.live.missing": "Ingen innlogging funnet",
  "settings.providers.live.window": "{{name}} {{used}} % brukt",
  "settings.providers.live.checkedAt": "Sjekket {{when}}",
  "settings.providers.live.checkedNow": "Sjekket nå nettopp",
