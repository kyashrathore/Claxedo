...
export const dict = {
  ...
  "provider.connect.changeMethod": "Endre",
  ...
  "settings.models.group.count": "{{enabled}} av {{total}}",
  "settings.models.group.enableAll": "Slå på alle",
  "settings.models.group.disableAll": "Slå av alle",
  "settings.models.tab.accounts": "Kontoer",
  "settings.models.tab.models": "Modeller",
  "settings.models.accounts.connection": "{{harness}} kjører på tilkoblingen den ble satt opp med.",
