export const dict = {
  ...
  "provider.connect.token.label": "{{provider}} 구독 토큰",
  "provider.connect.token.placeholder": "구독 토큰",
  "provider.connect.token.command": "터미널 명령",
  "provider.connect.oauth.description": "{{method}}(으)로 로그인합니다. Claxedo는 받은 토큰을 보관하고 {{provider}}에 사용합니다.",
  ...
  "settings.providers.agents.checkNow": "지금 확인",
  ...
  "settings.providers.agents.notSetUp": "설정되지 않음",
  "settings.providers.agents.usingAccount": "{{label}} 사용 중",
  "settings.providers.agents.usingMachine": "이 컴퓨터의 로그인 사용 중",
  "settings.providers.agents.headerRejected": "{{vendor}}이(가) {{label}}을(를) 거부했습니다. 다시 연결하거나 다른 계정을 선택하세요.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. 다시 연결하거나 다른 계정을 선택하세요.",
  "settings.providers.agents.machineLogin": "이 컴퓨터의 로그인",
  "settings.providers.agents.machineSource": "{{origin}}에서",
  "settings.providers.agents.unchecked": "확인하지 않음",
  "settings.providers.agents.accountMenu": "{{account}} 작업",
