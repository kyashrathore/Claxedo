export const dict = {
  ...
  "settings.providers.agents.scanning": "이 컴퓨터를 검사하는 중…",
  ...
  "settings.providers.agents.machineSource": "{{origin}}에서",
  ...
  "settings.providers.live.broken": "작동하지 않음",
  "settings.providers.live.unknown": "확인할 수 없음",
  "settings.providers.live.missing": "로그인을 찾을 수 없음",
