export const dict = {
  ...
  "settings.providers.section.harness": "{{harness}} 제공자",
  ...
  "settings.providers.section.pi": "Pi 프로바이더",
  "settings.providers.pi.description": "Pi는 Anthropic, OpenAI, OpenAI Codex를 지원합니다.",
  "settings.providers.section.opencode": "OpenCode 프로바이더",
