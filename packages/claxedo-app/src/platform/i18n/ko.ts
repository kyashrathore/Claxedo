export const dict = {
  ...
  "settings.general.row.showFileTree.description": "데스크톱 세션에서 파일 트리 토글과 패널을 표시합니다",
  "settings.general.row.showNavigation.title": "탐색 컨트롤",
  "settings.general.row.showNavigation.description": "데스크톱 제목 표시줄에 뒤로 및 앞으로 버튼을 표시합니다",
  "settings.general.row.showSearch.title": "명령 팔레트",
  "settings.general.row.showSearch.description": "데스크톱 제목 표시줄에 검색 및 명령 팔레트 버튼을 표시합니다",
  "settings.general.row.showTerminal.title": "터미널",
  "settings.general.row.showTerminal.description": "데스크톱 제목 표시줄에 터미널 버튼을 표시합니다",
  "settings.general.row.showStatus.title": "서버 상태",
  "settings.general.row.showStatus.description": "데스크톱 제목 표시줄에 서버 상태 버튼을 표시합니다",
  ...
  "settings.general.row.pinchZoom.description": "트랙패드 핀치 및 Ctrl 스크롤 제스처로 확대/축소를 허용합니다",
  ...
  "settings.models.showLess": "간략히 보기",
  ...
  "settings.providers.search.placeholder": "OpenCode 프로바이더 검색…",
