export const dict = {
  ...
  "settings.general.row.navigatorPlacement.title": "내비게이터 위치",
  "settings.general.row.navigatorPlacement.description": "파일, 변경 사항, 프로세스 내비게이터를 워크스페이스 패널 안에 표시할지 프로젝트 목록 옆 사이드바로 표시할지 선택하세요",
  "settings.general.row.navigatorPlacement.option.panel": "워크스페이스 패널",
  "settings.general.row.navigatorPlacement.option.sidebar": "사이드바",
