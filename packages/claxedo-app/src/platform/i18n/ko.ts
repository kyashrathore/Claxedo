export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "{{vendor}} API 키를 입력하면 이 계정으로 {{harness}}를 실행합니다.",
  "provider.connect.apiKey.description.engine": "{{vendor}} API 키를 입력하면 {{engine}}에서 {{vendor}} 모델을 사용할 수 있습니다.",
  ...
  "provider.connect.token.description": "아래 명령을 터미널에서 실행하고 출력된 토큰을 붙여넣으세요. 구독 토큰은 약 1년간 유효합니다.",
  "provider.connect.token.label": "{{vendor}} 구독 토큰",
  "provider.connect.token.placeholder": "구독 토큰",
  "provider.connect.token.command": "터미널 명령",
  "provider.connect.oauth.description.harness": "{{method}}으로 로그인하세요. Claxedo가 토큰을 보관하고 그것으로 {{harness}}를 실행합니다.",
  "provider.connect.oauth.description.engine": "{{method}}으로 로그인하세요. Claxedo가 받은 토큰을 보관하고 {{engine}}의 {{vendor}}에 사용합니다.",
  ...
  "settings.providers.agents.checking": "확인 중…",
  ...
  "settings.providers.agents.addAnotherAccount": "+ 다른 계정 추가",
  "settings.providers.agents.addFirstAccount": "계정 추가",
  ...
  "settings.providers.live.checkedAt": "{{when}} 확인함",
  "settings.providers.live.checkedNow": "방금 확인함",
