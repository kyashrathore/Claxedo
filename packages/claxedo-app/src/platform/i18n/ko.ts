export const dict = {
  ...
  "settings.models.providerSearch.hint": "총 {{total}}개 중 처음 {{shown}}개를 표시합니다. 다른 모델을 찾으려면 검색하세요.",
  ...
  "settings.providers.detect.description": "이 컴퓨터에서 Claude, Codex, Cursor 로그인을 검색한 다음 아래 상태를 업데이트합니다.",
