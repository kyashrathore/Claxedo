export const dict = {
  ...
  "settings.providers.agents.check": "확인",
  "settings.providers.agents.checking": "확인 중…",
  "settings.providers.agents.accountActive": "사용 중",
  ...
  "settings.providers.agents.accountExpires": "{{when}} 만료",
  "settings.providers.agents.switchLater": "Codex 계정 전환은 나중에 지원됩니다.",
  ...
  "settings.providers.status.broken": "확인 필요",
