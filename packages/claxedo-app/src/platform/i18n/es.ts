export const dict = {
  ...
  "settings.providers.agents.check": "Comprobar",
  "settings.providers.agents.checking": "Comprobando…",
  "settings.providers.agents.accountActive": "Activa",
  ...
  "settings.providers.agents.accountExpires": "Caduca {{when}}",
  "settings.providers.agents.switchLater": "El cambio de cuentas de Codex llegará más adelante.",
