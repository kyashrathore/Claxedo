export const dict = {
  ...
  "dialog.deeplink.open.title": "¿Abrir esta carpeta como proyecto?",
  "dialog.deeplink.open.body": "Un enlace abierto fuera de Claxedo pidió añadir esta carpeta a tus proyectos:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "El enlace también incluye este texto de prompt:\n\n{{prompt}}",
  ...
  "provider.connect.changeMethod": "Cambiar",
  ...
  "settings.models.group.enableAll": "Activar todos",
  "settings.models.group.disableAll": "Desactivar todos",
  "settings.models.tab.accounts": "Cuentas",
  "settings.models.tab.models": "Modelos",
  "settings.models.accounts.connection": "{{harness}} funciona con la conexión con la que se configuró.",
  "settings.models.group.expand": "Mostrar modelos de {{provider}}",
