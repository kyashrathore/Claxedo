export const dict = {
  ...
  "provider.connect.token.label": "Token de suscripción de {{provider}}",
  "provider.connect.token.placeholder": "Token de suscripción",
  "provider.connect.token.command": "Comando de terminal",
  "provider.connect.oauth.description": "Inicia sesión con {{method}}. Claxedo conserva el token que recibe y lo usa para {{provider}}.",
  ...
  "settings.providers.agents.checkNow": "Comprobar ahora",
  ...
  "settings.providers.agents.notSetUp": "Sin configurar",
  "settings.providers.agents.usingAccount": "Usando {{label}}",
  "settings.providers.agents.usingMachine": "Usando el inicio de sesión de este equipo",
  "settings.providers.agents.headerRejected": "{{vendor}} ha rechazado {{label}}. Vuelve a conectar o elige otra cuenta.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Vuelve a conectar o elige otra cuenta.",
  "settings.providers.agents.machineLogin": "Inicio de sesión de este equipo",
  "settings.providers.agents.machineSource": "de {{origin}}",
  "settings.providers.agents.unchecked": "Sin comprobar",
  "settings.providers.agents.accountMenu": "Acciones para {{account}}",
