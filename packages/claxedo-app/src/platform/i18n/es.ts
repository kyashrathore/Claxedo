export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Introduce tu clave API de {{vendor}} para ejecutar {{harness}} con esta cuenta.",
  "provider.connect.apiKey.description.engine": "Introduce tu clave API de {{vendor}} para usar modelos de {{vendor}} en {{engine}}.",
  ...
  "provider.connect.token.description": "Ejecuta el comando de abajo en una terminal y pega el token que imprime. Un token de suscripción dura alrededor de un año.",
  ...
  "provider.connect.oauth.description.harness": "Inicia sesión con {{method}}. Claxedo conserva el token y ejecuta {{harness}} con él.",
  "provider.connect.oauth.description.engine": "Inicia sesión con {{method}}. Claxedo conserva el token que recibe y lo usa para {{vendor}} en {{engine}}.",
  ...
  "settings.providers.agents.addAnotherAccount": "+ Añadir otra cuenta",
  "settings.providers.agents.addFirstAccount": "Añadir una cuenta",
  ...
  "settings.providers.live.broken": "No funciona",
  "settings.providers.live.unknown": "No se pudo comprobar",
  "settings.providers.live.missing": "No se encontró inicio de sesión",
  "settings.providers.live.window": "{{name}} {{used}} % usado",
  "settings.providers.live.checkedAt": "Comprobado {{when}}",
  "settings.providers.live.checkedNow": "Comprobado ahora mismo",
