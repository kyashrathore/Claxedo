...
export const dict = {
  ...
  "usage.quota.otherAgents": "本機上的其他代理",
  "usage.quota.throttled": "{{ago}}前已重新整理 · {{wait}}後再次重新整理",
  "usage.quota.summary": "{{window}} 剩餘 {{percent}}%",
  "usage.quota.summaryForAccount": "{{account}} 的 {{window}} 剩餘 {{percent}}%",
  "usage.quota.summaryReset": "{{summary}}，{{reset}} 後重設",
  "usage.quota.kicker": "來自你已連線的帳戶",
  "usage.quota.title": "配額週期",
  "usage.quota.empty": "沒有已連線的帳戶在此回報方案。",
  "usage.quota.inUse": "使用中",
  "usage.quota.windowLeft": "剩餘 {{percent}}%",
  "usage.quota.windowResets": "{{reset}} 後重設",
  "usage.quota.windowUsed": "{{account}} {{window}}：已用 {{percent}}%",
  "usage.quota.resetNow": "現在",
