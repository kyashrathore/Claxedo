...
export const dict = {
  ...
  "dialog.deeplink.open.title": "將此資料夾開啟為專案？",
  "dialog.deeplink.open.body": "來自 Claxedo 外部的連結要求將此資料夾加入你的專案:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "該連結還帶有以下提示詞:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "開啟",
  ...
  "provider.connect.changeMethod": "變更",
  ...
  "settings.models.group.count": "{{enabled}}/{{total}}",
  "settings.models.group.enableAll": "全部啟用",
  "settings.models.group.disableAll": "全部停用",
  "settings.models.tab.accounts": "帳戶",
  "settings.models.tab.models": "模型",
  "settings.models.accounts.connection": "{{harness}} 使用其設定時的連線執行。",
  "settings.models.group.expand": "顯示 {{provider}} 模型",
