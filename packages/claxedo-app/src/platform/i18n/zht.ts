...
export const dict = {
  ...
  "settings.providers.agents.scanning": "正在掃描本機…",
  ...
  "settings.providers.agents.machineSource": "來自 {{origin}}",
  ...
  "settings.providers.live.broken": "不可用",
  "settings.providers.live.unknown": "無法檢查",
  "settings.providers.live.missing": "未找到登入",
