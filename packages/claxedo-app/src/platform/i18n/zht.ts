...
export const dict = {
  ...
  "settings.general.row.showFileTree.description": "在桌面工作階段中顯示檔案樹開關和面板",
  "settings.general.row.showNavigation.title": "導覽控制項",
  "settings.general.row.showNavigation.description": "在桌面標題列中顯示上一步和下一步按鈕",
  ...
  "settings.general.row.pinchZoom.description": "允許使用觸控板捏合和 Ctrl+捲動手勢進行縮放",
