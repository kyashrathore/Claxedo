...
export const dict = {
  ...
  "provider.connect.token.label": "{{provider}} 訂閱權杖",
  "provider.connect.token.placeholder": "訂閱權杖",
  "provider.connect.token.command": "終端機指令",
  "provider.connect.oauth.description": "使用 {{method}} 登入。Claxedo 會保留收到的權杖並用於 {{provider}}。",
  ...
  "settings.providers.agents.checkNow": "立即檢查",
  ...
  "settings.providers.agents.usingAccount": "正在使用 {{label}}",
  "settings.providers.agents.usingMachine": "正在使用本機登入",
  "settings.providers.agents.headerRejected": "{{vendor}} 已拒絕 {{label}}。請重新連線或選擇其他帳戶。",
  "settings.providers.agents.headerUnusable": "{{label}}：{{verdict}}。請重新連線或選擇其他帳戶。",
  "settings.providers.agents.machineLogin": "本機登入",
  "settings.providers.agents.machineSource": "來自 {{origin}}",
  "settings.providers.agents.unchecked": "未檢查",
  "settings.providers.agents.accountMenu": "{{account}} 的操作",
