...
export const dict = {
  ...
  "settings.providers.agents.check": "檢查",
  ...
  "settings.providers.agents.accountExpires": "{{when}}到期",
  "settings.providers.agents.switchLater": "切換 Codex 帳戶稍後推出。",
  ...
  "settings.providers.status.broken": "需要處理",
