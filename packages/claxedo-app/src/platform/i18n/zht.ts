...
export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "輸入你的 {{vendor}} API 金鑰，即可用該帳戶執行 {{harness}}。",
  "provider.connect.apiKey.description.engine": "輸入你的 {{vendor}} API 金鑰，即可在 {{engine}} 中使用 {{vendor}} 模型。",
  ...
  "provider.connect.token.description": "在終端機執行下方指令並貼上其輸出的權杖。訂閱權杖約一年有效。",
  "provider.connect.token.label": "{{vendor}} 訂閱權杖",
  "provider.connect.token.placeholder": "訂閱權杖",
  "provider.connect.token.command": "終端機指令",
  "provider.connect.oauth.description.harness": "使用 {{method}} 登入。Claxedo 會保存該權杖，並用它執行 {{harness}}。",
  "provider.connect.oauth.description.engine": "使用 {{method}} 登入。Claxedo 會保存收到的權杖，並將其用於 {{engine}} 中的 {{vendor}}。",
  ...
  "settings.providers.agents.addAnotherAccount": "+ 新增另一個帳戶",
  "settings.providers.agents.addFirstAccount": "新增帳戶",
