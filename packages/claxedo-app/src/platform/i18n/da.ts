export const dict = {
  ...
  "dialog.deeplink.open.title": "Åbn denne mappe som et projekt?",
  "dialog.deeplink.open.body": "Et link åbnet uden for Claxedo bad om at tilføje denne mappe til dine projekter:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "Linket indeholder også denne prompttekst:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "Åbn",
  ...
  "provider.connect.changeMethod": "Skift",
  ...
  "settings.models.group.count": "{{enabled}} af {{total}}",
  "settings.models.group.enableAll": "Aktivér alle",
  "settings.models.group.disableAll": "Deaktivér alle",
  "settings.models.tab.accounts": "Konti",
  "settings.models.tab.models": "Modeller",
  "settings.models.accounts.connection": "{{harness}} kører på den forbindelse, den blev sat op med.",
  "settings.models.group.expand": "Vis modeller fra {{provider}}",
