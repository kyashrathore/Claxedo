export const dict = {
  ...
  "settings.providers.agents.checkNow": "Tjek nu",
  ...
  "settings.providers.agents.notSetUp": "Ikke konfigureret",
  "settings.providers.agents.usingAccount": "Bruger {{label}}",
  "settings.providers.agents.usingMachine": "Bruger denne computers login",
  "settings.providers.agents.headerRejected": "{{label}} er afvist af {{vendor}}. Tilslut igen, eller vælg en anden konto.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Tilslut igen, eller vælg en anden konto.",
  "settings.providers.agents.machineLogin": "Denne computers login",
  "settings.providers.agents.machineSource": "fra {{origin}}",
  "settings.providers.agents.unchecked": "Ikke tjekket",
  "settings.providers.agents.accountMenu": "Handlinger for {{account}}",
