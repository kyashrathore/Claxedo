export const dict = {
  ...
  "provider.connect.apiKey.label": "{{vendor}} API-nøgle",
  ...
  "provider.connect.label.placeholder": "name@company.com eller et navn, du kan genkende",
  "provider.connect.label.required": "Tilføj en etiket, så du kan genkende denne konto",
  ...
  "provider.connect.oauth.code.visit.suffix.engine": " for at hente din autorisationskode og bruge {{vendor}}-modeller i {{engine}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix.harness": " og indtast koden nedenfor for at køre {{harness}} på denne konto.",
  "provider.connect.oauth.auto.visit.suffix.engine": " og indtast koden nedenfor for at bruge {{vendor}}-modeller i {{engine}}.",
  "provider.connect.oauth.auto.confirmationCode": "Bekræftelseskode",
  "provider.connect.toast.connected.title": "{{vendor}} forbundet",
  "provider.connect.toast.connected.description.harness": "{{harness}} kører nu på denne konto.",
  "provider.connect.toast.connected.description.engine": "{{vendor}}-modeller er nu tilgængelige i {{engine}}.",
  ...
  "common.lastChecked": "Sidst tjekket {{ago}}",
  ...
  "settings.providers.agents.checkAccount": "Tjek",
  "settings.providers.agents.scanning": "Scanner denne maskine…",
  "settings.providers.agents.rescanning": "Scanner…",
  "settings.providers.agents.scanFailed": "Kunne ikke læse denne maskine",
  "settings.providers.agents.scannedNow": "Scannet lige nu",
  "settings.providers.agents.scannedAt": "Scannet {{when}}",
  "settings.providers.agents.rescan": "Scan igen",
  "settings.providers.agents.machineLogin": "Denne computers login",
  "settings.providers.agents.addAccount": "Tilføj en konto",
  "settings.providers.agents.machinePlan": "{{plan}}-abonnement",
  "settings.providers.agents.machineSignedOut": "Ikke logget ind — kør {{command}}",
  "settings.providers.agents.machineNotInstalled": "Ikke installeret",
  ...
  "settings.providers.agents.reconnectAccount": "Tilslut igen",
  "settings.providers.agents.removeAccount": "Fjern",
  "settings.providers.agents.removeAccountConfirm": "Fjern konto?",
  ...
  "usage.quota.otherAgents": "Andre agenter på denne maskine",
  "usage.quota.throttled": "Opdateret for {{ago}} siden · næste opdatering om {{wait}}",
  "usage.quota.summary": "{{percent}}% tilbage på {{window}}",
  "usage.quota.summaryForAccount": "{{percent}}% tilbage på {{window}} for {{account}}",
  "usage.quota.summaryReset": "{{summary}}, nulstilles om {{reset}}",
  "usage.quota.kicker": "Fra dine tilsluttede konti",
  "usage.quota.title": "Kvotevinduer",
  "usage.quota.empty": "Ingen tilsluttet konto rapporterer en plan her.",
  "usage.quota.inUse": "I brug",
  "usage.quota.windowLeft": "{{percent}}% tilbage",
  "usage.quota.windowResets": "nulstilles om {{reset}}",
  "usage.quota.windowUsed": "{{account}} {{window}}: {{percent}}% brugt",
  "usage.quota.resetNow": "nu",
  "settings.providers.connect.subtitle": "Gemt for {{provider}} på denne computer. Esc lukker uden at gemme.",
  "settings.providers.connect.reconnectTitle": "Tilslut {{provider}} igen",
  "settings.providers.connect.reconnectSubtitle": "Erstatter tokenet på denne konto og beholder dens navn og plads på listen. Esc lukker uden at gemme.",
