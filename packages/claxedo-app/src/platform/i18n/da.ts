export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Indtast din {{vendor}} API-nøgle for at køre {{harness}} på denne konto.",
  "provider.connect.apiKey.description.engine": "Indtast din {{vendor}} API-nøgle for at bruge {{vendor}}-modeller i {{engine}}.",
  ...
  "provider.connect.oauth.description.harness": "Log ind med {{method}}. Claxedo gemmer tokenet og kører {{harness}} med det.",
  "provider.connect.oauth.description.engine": "Log ind med {{method}}. Claxedo gemmer det modtagne token og bruger det til {{vendor}} i {{engine}}.",
  ...
  "settings.providers.agents.addAnotherAccount": "+ Tilføj en konto mere",
  "settings.providers.agents.addFirstAccount": "Tilføj en konto",
