export const dict = {
  ...
  "settings.providers.description": "All provider setup happens here. Use Detect on Agents to refresh Claude, Codex, and Cursor status.",
  ...
  "settings.providers.search.placeholder": "Search OpenCode providers…",
