export const dict = {
  ...
  "provider.connect.token.label": "{{provider}} subscription token",
  "provider.connect.token.placeholder": "Subscription token",
  "provider.connect.token.command": "Terminal command",
  "provider.connect.oauth.description": "Sign in with {{method}}. Claxedo keeps the token it receives and uses it for {{provider}}.",
  ...
  "settings.providers.agents.checkNow": "Check now",
  ...
  "settings.providers.agents.notSetUp": "Not set up",
  "settings.providers.agents.usingAccount": "Using {{label}}",
  "settings.providers.agents.usingMachine": "Using this computer's login",
  "settings.providers.agents.headerRejected": "{{label}} is rejected by {{vendor}}. Reconnect or pick another account.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Reconnect or pick another account.",
  "settings.providers.agents.machineLogin": "This computer's login",
  "settings.providers.agents.machineSource": "from {{origin}}",
  "settings.providers.agents.unchecked": "Not checked",
  "settings.providers.agents.accountMenu": "Actions for {{account}}",
