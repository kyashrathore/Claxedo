export const dict = {
  ...
  "settings.providers.description": "Choose a workspace and an agent, then connect the providers it uses there.",
  ...
  "settings.models.showMore": "Show more",
  "settings.models.showLess": "Show less",
  "settings.models.previewCount": "Show {{count}} more",
