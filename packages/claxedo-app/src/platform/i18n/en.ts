export const dict = {
  ...
  "dialog.deeplink.open.title": "Open this folder as a project?",
  "dialog.deeplink.open.body": "A link opened from outside Claxedo asked to add this folder to your projects:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "The link also carries this prompt text:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "Open",
  ...
  "provider.connect.changeMethod": "Change",
  ...
  "settings.models.group.count": "{{enabled}} of {{total}}",
  "settings.models.group.enableAll": "Enable all",
  "settings.models.group.disableAll": "Disable all",
  "settings.models.tab.accounts": "Accounts",
  "settings.models.tab.models": "Models",
  "settings.models.accounts.connection": "{{harness}} runs on the connection it was set up with.",
  "settings.models.group.expand": "Show {{provider}} models",
