export const dict = {
  ...
  "settings.providers.agents.scanning": "Scanning this computer…",
  ...
  "settings.providers.agents.machineSource": "from {{origin}}",
  ...
  "settings.providers.live.broken": "Not working",
  "settings.providers.live.unknown": "Couldn't check",
  "settings.providers.live.missing": "No login found",
