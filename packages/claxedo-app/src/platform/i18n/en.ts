export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Enter your {{vendor}} API key to run {{harness}} on this account.",
  "provider.connect.apiKey.description.engine": "Enter your {{vendor}} API key to use {{vendor}} models in {{engine}}.",
  ...
  "provider.connect.token.description": "Run the command below in a terminal and paste the token it prints. A subscription token lasts about a year.",
  ...
  "provider.connect.oauth.description.harness": "Sign in with {{method}}. Claxedo keeps the token and runs {{harness}} on it.",
  "provider.connect.oauth.description.engine": "Sign in with {{method}}. Claxedo keeps the token it receives and uses it for {{vendor}} in {{engine}}.",
  ...
  "settings.providers.agents.addAnotherAccount": "+ Add another account",
  "settings.providers.agents.addFirstAccount": "Add an account",
