export const dict = {
  ...
  "common.lastChecked": "Last checked {{ago}}",
  ...
  "settings.providers.agents.reachLocal": "This computer",
  "settings.providers.agents.reachCloud": "Cloud sandboxes",
  "settings.providers.agents.reachLocalCloudNote": "Runs on this computer and in cloud sandboxes.",
  "settings.providers.agents.reachLocalOnlyNote": "Only workspaces on this computer can use this login. Cloud sandboxes need an account added here.",
  ...
  "usage.quota.notChecked": "Not checked yet",
  "usage.quota.check": "Check",
  "usage.quota.reconnect": "Reconnect in Settings",
  "usage.quota.otherAgents": "Other agents on this machine",
  "usage.quota.throttled": "Refreshed {{ago}} ago · next refresh in {{wait}}",
  "usage.quota.summary": "{{percent}}% left on {{window}}",
  "usage.quota.summaryForAccount": "{{percent}}% left on {{window}} for {{account}}",
  "usage.quota.summaryReset": "{{summary}}, back in {{reset}}",
  "usage.quota.kicker": "From your connected accounts", "usage.quota.title": "Quota windows",
  "usage.quota.empty": "No connected account reports a plan here.", "usage.quota.inUse": "In use",
  "usage.quota.resetNow": "now", "usage.quota.windowLeft": "{{percent}}% left",
  "usage.quota.windowResets": "resets {{reset}}", "usage.quota.windowUsed": "{{account}} {{window}}: {{percent}}% used",
