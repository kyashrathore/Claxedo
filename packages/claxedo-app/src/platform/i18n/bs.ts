export const dict = {
  ...
  "settings.providers.agents.check": "Provjeri",
  "settings.providers.agents.checking": "Provjera…",
  "settings.providers.agents.accountActive": "Aktivan",
  ...
  "settings.providers.agents.accountExpires": "Ističe {{when}}",
  "settings.providers.agents.switchLater": "Prebacivanje Codex računa stiže kasnije.",
