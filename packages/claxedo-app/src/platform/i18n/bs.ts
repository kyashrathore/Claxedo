export const dict = {
  ...
  "provider.connect.token.label": "{{provider}} pretplatnički token",
  "provider.connect.token.placeholder": "Pretplatnički token",
  "provider.connect.token.command": "Naredba u terminalu",
  "provider.connect.oauth.description": "Prijavite se putem {{method}}. Claxedo čuva primljeni token i koristi ga za {{provider}}.",
  ...
  "settings.providers.agents.checkNow": "Provjeri sada",
  ...
  "settings.providers.agents.notSetUp": "Nije podešeno",
  "settings.providers.agents.usingAccount": "Koristi se {{label}}",
  "settings.providers.agents.usingMachine": "Koristi se prijava na ovom računaru",
  "settings.providers.agents.headerRejected": "{{vendor}} je odbio {{label}}. Ponovo povežite ili odaberite drugi račun.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Ponovo povežite ili odaberite drugi račun.",
  "settings.providers.agents.machineLogin": "Prijava na ovom računaru",
  "settings.providers.agents.machineSource": "iz {{origin}}",
  "settings.providers.agents.unchecked": "Nije provjereno",
  "settings.providers.agents.accountMenu": "Radnje za {{account}}",
