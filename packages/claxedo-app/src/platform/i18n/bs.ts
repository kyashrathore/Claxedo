export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Unesite svoj {{vendor}} API ključ da biste pokrenuli {{harness}} na ovom računu.",
  "provider.connect.apiKey.description.engine": "Unesite svoj {{vendor}} API ključ da biste koristili {{vendor}} modele u {{engine}}.",
  ...
  "provider.connect.token.description": "Pokrenite naredbu ispod u terminalu i zalijepite token koji ispiše. Pretplatnički token traje oko godinu dana.",
  ...
  "provider.connect.oauth.description.harness": "Prijavite se putem {{method}}. Claxedo čuva token i pokreće {{harness}} s njim.",
  "provider.connect.oauth.description.engine": "Prijavite se putem {{method}}. Claxedo čuva primljeni token i koristi ga za {{vendor}} u {{engine}}.",
  ...
  "settings.providers.agents.machineSource": "iz {{origin}}",
  "settings.providers.agents.addAnotherAccount": "+ Dodaj još jedan račun",
  "settings.providers.agents.addFirstAccount": "Dodaj račun",
  ...
  "settings.providers.live.broken": "Ne radi",
  "settings.providers.live.unknown": "Provjera nije uspjela",
  "settings.providers.live.missing": "Prijava nije pronađena",
  "settings.providers.live.window": "{{name}} iskorišteno {{used}}%",
  "settings.providers.live.checkedAt": "Provjereno {{when}}",
  "settings.providers.live.checkedNow": "Upravo provjereno",
