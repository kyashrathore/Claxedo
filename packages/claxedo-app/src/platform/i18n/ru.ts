export const dict = {
  ...
  "settings.providers.agents.scanning": "Сканирование этого компьютера…",
  ...
  "settings.providers.agents.machineSource": "из {{origin}}",
  ...
  "settings.providers.live.broken": "Не работает",
  "settings.providers.live.unknown": "Не удалось проверить",
  "settings.providers.live.missing": "Вход не найден",
