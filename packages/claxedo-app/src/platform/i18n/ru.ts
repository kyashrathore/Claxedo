export const dict = {
  ...
  "dialog.deeplink.open.title": "Открыть эту папку как проект?",
  "dialog.deeplink.open.body": "Ссылка, открытая вне Claxedo, запросила добавление этой папки в ваши проекты:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "Ссылка также содержит такой текст запроса:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "Открыть",
  ...
  "provider.connect.changeMethod": "Изменить",
  ...
  "settings.models.group.count": "{{enabled}} из {{total}}",
  "settings.models.group.enableAll": "Включить все",
  "settings.models.group.disableAll": "Отключить все",
  "settings.models.tab.accounts": "Аккаунты",
  "settings.models.tab.models": "Модели",
  "settings.models.accounts.connection": "{{harness}} работает через подключение, с которым он был настроен.",
  "settings.models.group.expand": "Показать модели {{provider}}",
