export const dict = {
  ...
  "settings.providers.agents.check": "Проверить",
  "settings.providers.agents.checking": "Проверка…",
  "settings.providers.agents.accountActive": "Активный",
  "settings.providers.agents.makeActive": "Сделать активным",
  "settings.providers.agents.makingActive": "Переключение…",
  ...
  "settings.providers.agents.accountExpires": "Истекает {{when}}",
  "settings.providers.agents.switchLater": "Переключение аккаунтов Codex появится позже.",
