export const dict = {
  ...
  "settings.models.providerSearch.hint": "Показаны первые {{shown}} из {{total}}. Воспользуйтесь поиском, чтобы найти остальные.",
  ...
  "settings.providers.detect.description": "Сканирует этот компьютер на наличие входов Claude, Codex и Cursor, затем обновляет статус ниже.",
