export const dict = {
  ...
  "prompt.imageMarks.open": "Отметить на изображении",
  "prompt.imageMarks.delete": "Удалить метку",
  "prompt.imageMarks.mark": "метка {{number}}",
  "prompt.imageMarks.remove": "Убрать метку",
  ...
  "session.requests.loadFailed": "Не удалось загрузить ожидающие разрешения или вопросы. Повторите попытку, чтобы продолжить.",
