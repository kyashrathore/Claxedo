export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Введите ключ API {{vendor}}, чтобы запускать {{harness}} с этой учётной записью.",
  "provider.connect.apiKey.description.engine": "Введите ключ API {{vendor}}, чтобы использовать модели {{vendor}} в {{engine}}.",
  ...
  "provider.connect.token.description": "Выполните команду ниже в терминале и вставьте выведенный токен. Токен подписки действует около года.",
  ...
  "provider.connect.oauth.description.harness": "Войдите через {{method}}. Claxedo сохранит токен и будет запускать с ним {{harness}}.",
  "provider.connect.oauth.description.engine": "Войдите через {{method}}. Claxedo сохранит полученный токен и будет использовать его для {{vendor}} в {{engine}}.",
  ...
  "settings.providers.agents.checking": "Проверка…",
  ...
  "settings.providers.agents.addAnotherAccount": "+ Добавить ещё один аккаунт",
  "settings.providers.agents.addFirstAccount": "Добавить аккаунт",
  ...
  "settings.providers.live.checkedAt": "Проверено {{when}}",
  "settings.providers.live.checkedNow": "Проверено только что",
