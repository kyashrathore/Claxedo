export const dict = {
  ...
  "provider.connect.token.label": "Токен подписки {{provider}}",
  "provider.connect.token.placeholder": "Токен подписки",
  "provider.connect.token.command": "Команда терминала",
  "provider.connect.oauth.description": "Войдите через {{method}}. Claxedo сохраняет полученный токен и использует его для {{provider}}.",
  ...
  "settings.providers.agents.checkNow": "Проверить сейчас",
  ...
  "settings.providers.agents.notSetUp": "Не настроено",
  "settings.providers.agents.usingAccount": "Используется {{label}}",
  "settings.providers.agents.usingMachine": "Используется вход на этом компьютере",
  "settings.providers.agents.headerRejected": "{{vendor}} отклонил {{label}}. Переподключите или выберите другой аккаунт.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Переподключите или выберите другой аккаунт.",
  "settings.providers.agents.machineLogin": "Вход на этом компьютере",
  "settings.providers.agents.machineSource": "из {{origin}}",
  "settings.providers.agents.unchecked": "Не проверено",
  "settings.providers.agents.accountMenu": "Действия для {{account}}",
