...
export const dict = {
  ...
  "settings.providers.agents.check": "Prüfen",
  "settings.providers.agents.checking": "Wird geprüft…",
  "settings.providers.agents.accountActive": "Aktiv",
  "settings.providers.agents.makeActive": "Aktiv setzen",
  "settings.providers.agents.makingActive": "Wird gewechselt…",
  ...
  "settings.providers.agents.accountExpires": "Läuft {{when}} ab",
  "settings.providers.agents.switchLater": "Der Wechsel zwischen Codex-Konten kommt später.",
