...
export const dict = {
  ...
  "provider.connect.token.label": "{{provider}}-Abonnement-Token",
  "provider.connect.token.placeholder": "Abonnement-Token",
  "provider.connect.token.command": "Terminalbefehl",
  "provider.connect.oauth.description": "Melden Sie sich mit {{method}} an. Claxedo behält das erhaltene Token und verwendet es für {{provider}}.",
  ...
  "settings.providers.agents.checkNow": "Jetzt prüfen",
  ...
  "settings.providers.agents.notSetUp": "Nicht eingerichtet",
  "settings.providers.agents.usingAccount": "Verwendet {{label}}",
  "settings.providers.agents.usingMachine": "Verwendet das Login dieses Rechners",
  "settings.providers.agents.headerRejected": "{{label}} wurde von {{vendor}} abgelehnt. Neu verbinden oder ein anderes Konto wählen.",
  "settings.providers.agents.headerUnusable": "{{label}}: {{verdict}}. Neu verbinden oder ein anderes Konto wählen.",
  "settings.providers.agents.machineLogin": "Login dieses Rechners",
  "settings.providers.agents.machineSource": "aus {{origin}}",
  "settings.providers.agents.unchecked": "Nicht geprüft",
  "settings.providers.agents.accountMenu": "Aktionen für {{account}}",
