...
export const dict = {
  ...
  "settings.models.providerSearch.hint": "Es werden die ersten {{shown}} von {{total}} angezeigt. Suche nach weiteren Modellen.",
  ...
  "settings.providers.detect.description": "Durchsucht diesen Computer nach Claude-, Codex- und Cursor-Anmeldungen und aktualisiert dann den Status unten.",
