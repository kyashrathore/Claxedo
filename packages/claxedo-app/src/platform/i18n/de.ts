...
export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Geben Sie Ihren {{vendor}} API-Schlüssel ein, um {{harness}} mit diesem Konto auszuführen.",
  "provider.connect.apiKey.description.engine": "Geben Sie Ihren {{vendor}} API-Schlüssel ein, um {{vendor}} Modelle in {{engine}} zu nutzen.",
  ...
  "provider.connect.token.description": "Führen Sie den Befehl unten in einem Terminal aus und fügen Sie das ausgegebene Token ein. Ein Abonnement-Token gilt etwa ein Jahr.",
  ...
  "provider.connect.oauth.description.harness": "Melden Sie sich mit {{method}} an. Claxedo behält das Token und führt {{harness}} damit aus.",
  "provider.connect.oauth.description.engine": "Melden Sie sich mit {{method}} an. Claxedo behält das erhaltene Token und verwendet es für {{vendor}} in {{engine}}.",
  ...
  "settings.providers.agents.checking": "Wird geprüft…",
  ...
  "settings.providers.agents.addAnotherAccount": "+ Weiteres Konto hinzufügen",
  "settings.providers.agents.addFirstAccount": "Konto hinzufügen",
  ...
  "settings.providers.live.checkedAt": "Geprüft {{when}}",
  "settings.providers.live.checkedNow": "Gerade geprüft",
