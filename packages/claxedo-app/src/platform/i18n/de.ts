...
export const dict = {
  ...
  "settings.providers.agents.scanning": "Dieser Rechner wird durchsucht…",
  ...
  "settings.providers.agents.machineSource": "aus {{origin}}",
  ...
  "settings.providers.live.broken": "Funktioniert nicht",
  "settings.providers.live.unknown": "Prüfung nicht möglich",
  "settings.providers.live.missing": "Kein Login gefunden",
