...
export const dict = {
  ...
  "settings.providers.detect.description": "扫描本机的 Claude、Codex 和 Cursor 登录信息，然后更新下方状态。",
  "settings.providers.agents.sharedCredential": "一次设置即可覆盖 ACP 和原生 SDK。",
  "settings.providers.agents.useLogin": "使用此登录",
  "settings.providers.agents.inUse": "使用中：{{label}}",
  "settings.providers.agents.inUseMachine": "使用中：此电脑的登录",
  "settings.providers.agents.check": "检查",
  "settings.providers.agents.checking": "正在检查…",
  "settings.providers.agents.accountActive": "使用中",
  "settings.providers.agents.makeActive": "设为使用中",
  "settings.providers.agents.makingActive": "正在切换…",
  ...
  "settings.providers.agents.accountExpires": "{{when}}过期",
  "settings.providers.agents.switchLater": "切换 Codex 账户稍后推出。",
  ...
  "settings.providers.status.broken": "需要处理",
