...
export const dict = {
  ...
  "provider.connect.token.label": "{{provider}} 订阅令牌",
  "provider.connect.token.placeholder": "订阅令牌",
  "provider.connect.token.command": "终端命令",
  "provider.connect.oauth.description": "使用 {{method}} 登录。Claxedo 会保留收到的令牌并用于 {{provider}}。",
  ...
  "settings.providers.agents.checkNow": "立即检查",
  ...
  "settings.providers.agents.notSetUp": "未设置",
  "settings.providers.agents.usingAccount": "正在使用 {{label}}",
  "settings.providers.agents.usingMachine": "正在使用本机登录",
  "settings.providers.agents.headerRejected": "{{vendor}} 已拒绝 {{label}}。请重新连接或选择其他账户。",
  "settings.providers.agents.headerUnusable": "{{label}}：{{verdict}}。请重新连接或选择其他账户。",
  "settings.providers.agents.machineLogin": "本机登录",
  "settings.providers.agents.machineSource": "来自 {{origin}}",
  "settings.providers.agents.unchecked": "未检查",
