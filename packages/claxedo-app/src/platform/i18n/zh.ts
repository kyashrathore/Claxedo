...
export const dict = {
  ...
  "dialog.deeplink.open.title": "将此文件夹作为项目打开？",
  "dialog.deeplink.open.body": "来自 Claxedo 外部的链接请求把此文件夹添加到你的项目:\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "该链接还携带以下提示词:\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "打开",
  ...
  "settings.models.group.enableAll": "全部启用",
