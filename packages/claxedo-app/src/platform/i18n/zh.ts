...
export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "输入你的 {{vendor}} API 密钥，即可用该账户运行 {{harness}}。",
  "provider.connect.apiKey.description.engine": "输入你的 {{vendor}} API 密钥，即可在 {{engine}} 中使用 {{vendor}} 模型。",
  ...
  "provider.connect.token.description": "在终端运行下面的命令并粘贴其输出的令牌。订阅令牌约一年有效。",
  "provider.connect.token.label": "{{vendor}} 订阅令牌",
  "provider.connect.token.placeholder": "订阅令牌",
  "provider.connect.token.command": "终端命令",
  "provider.connect.oauth.description.harness": "使用 {{method}} 登录。Claxedo 会保存该令牌，并用它运行 {{harness}}。",
  "provider.connect.oauth.description.engine": "使用 {{method}} 登录。Claxedo 会保存收到的令牌，并将其用于 {{engine}} 中的 {{vendor}}。",
  ...
  "settings.providers.agents.checking": "正在检查…",
  "settings.providers.agents.checkAccount": "检查",
  "settings.providers.agents.scanning": "正在扫描本机…",
  ...
  "settings.providers.agents.machineSource": "来自 {{origin}}",
  "settings.providers.agents.addAnotherAccount": "+ 添加另一个账户",
  "settings.providers.agents.addFirstAccount": "添加账户",
  ...
  "settings.providers.live.missing": "未找到登录",
  "settings.providers.live.window": "{{name}} 已用 {{used}}%",
  "settings.providers.live.checkedAt": "{{when}}检查",
  "settings.providers.live.checkedNow": "刚刚检查",
  "settings.providers.window.session": "会话",
  "settings.providers.window.weekly": "每周",
  "settings.providers.window.weeklyOpus": "每周 · Opus",
  "settings.providers.connect.title": "连接 {{provider}}",
