...
export const LOCALE_ENTRIES: readonly LocaleEntry[] = [
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./zh").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/zh"),
      ),
    intlTag: "zh-Hans",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./zht").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/zht"),
      ),
    intlTag: "zh-Hant",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./ko").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/ko"),
      ),
    intlTag: "ko",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./de").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/de"),
      ),
    intlTag: "de",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./es").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/es"),
      ),
    intlTag: "es",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./fr").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/fr"),
      ),
    intlTag: "fr",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./da").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/da"),
      ),
    intlTag: "da",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./ja").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/ja"),
      ),
    intlTag: "ja",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./pl").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/pl"),
      ),
    intlTag: "pl",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./ru").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/ru"),
      ),
    intlTag: "ru",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./bs").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/bs"),
      ),
    intlTag: "bs",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./ar").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/ar"),
      ),
    intlTag: "ar",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./no").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/no"),
      ),
    intlTag: "nb-NO",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./pt-BR").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/br"),
      ),
    intlTag: "pt-BR",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./th").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/th"),
      ),
    intlTag: "th",
  ...
  },
  {
    ...
    loader: () =>
      loadMerged(
        import("./tr").then((m) => ({ dict: m.dict })),
        import("@opencode-ai/ui/i18n/tr"),
      ),
    intlTag: "tr",
