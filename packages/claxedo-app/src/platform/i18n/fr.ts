export const dict = {
  ...
  "settings.providers.agents.checkNow": "Vérifier maintenant",
  ...
  "settings.providers.agents.notSetUp": "Non configuré",
  "settings.providers.agents.usingAccount": "Utilise {{label}}",
  "settings.providers.agents.usingMachine": "Utilise la connexion de cet ordinateur",
  "settings.providers.agents.headerRejected": "{{label}} a été refusé par {{vendor}}. Reconnectez-vous ou choisissez un autre compte.",
  "settings.providers.agents.headerUnusable": "{{label}} : {{verdict}}. Reconnectez-vous ou choisissez un autre compte.",
  "settings.providers.agents.machineLogin": "Connexion de cet ordinateur",
  "settings.providers.agents.machineSource": "depuis {{origin}}",
  "settings.providers.agents.unchecked": "Non vérifié",
  "settings.providers.agents.accountMenu": "Actions pour {{account}}",
