export const dict = {
  ...
  "provider.connect.apiKey.label": "Clé API {{vendor}}",
  "provider.connect.apiKey.placeholder": "Clé API",
  "provider.connect.apiKey.required": "La clé API est requise",
  "provider.connect.label.label": "Libellé",
  "provider.connect.label.placeholder": "name@company.com ou un nom que vous reconnaîtrez",
  "provider.connect.label.required": "Ajoutez un libellé pour reconnaître ce compte",
  "provider.connect.token.label": "Jeton d'abonnement {{vendor}}",
  ...
  "provider.connect.oauth.code.visit.suffix.engine": " pour récupérer votre code d'autorisation et utiliser les modèles {{vendor}} dans {{engine}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix.harness": " et saisissez le code ci-dessous pour exécuter {{harness}} avec ce compte.",
  "provider.connect.oauth.auto.visit.suffix.engine": " et saisissez le code ci-dessous pour utiliser les modèles {{vendor}} dans {{engine}}.",
  "provider.connect.oauth.auto.confirmationCode": "Code de confirmation",
  "provider.connect.toast.connected.title": "{{vendor}} connecté",
  "provider.connect.toast.connected.description.harness": "{{harness}} s'exécute maintenant avec ce compte.",
  "provider.connect.toast.connected.description.engine": "Les modèles {{vendor}} sont maintenant disponibles dans {{engine}}.",
  ...
  "common.lastChecked": "Dernière vérification {{ago}}",
  ...
  "prompt.toast.attachmentHarnessUnsupported.description":
    "{{harness}} n'a pas d'entrée de prompt pour {{mime}}, et cette session n'a pas de dossier d'espace de travail pour conserver le fichier.",
  ...
  "home.empty.description": "Commencez par ouvrir un dossier de cet ordinateur",
  "home.title": "Accueil",
  ...
  "settings.providers.agents.machineLogin": "Connexion de cet ordinateur",
  "settings.providers.agents.addAccount": "Ajouter un compte",
  "settings.providers.agents.machinePlan": "Forfait {{plan}}",
  ...
  "settings.providers.agents.reconnectAccount": "Reconnecter",
  ...
  "usage.quota.notChecked": "Pas encore vérifié",
  ...
  "usage.quota.kicker": "Depuis vos comptes connectés",
  ...
  "usage.quota.windowLeft": "{{percent}}% restants",
  "usage.quota.windowResets": "réinitialisé dans {{reset}}",
  "usage.quota.windowUsed": "{{account}} {{window}} : {{percent}}% utilisés",
  "usage.quota.resetNow": "maintenant",
  "settings.providers.connect.subtitle": "Enregistré pour {{provider}} sur cet ordinateur. Échap ferme sans enregistrer.",
  "settings.providers.connect.reconnectTitle": "Reconnecter {{provider}}",
  "settings.providers.connect.reconnectSubtitle": "Remplace le jeton de ce compte en conservant son nom et sa place dans la liste. Échap ferme sans enregistrer.",
