export const dict = {
  ...
  "provider.connect.apiKey.description.harness": "Saisissez votre clé API {{vendor}} pour exécuter {{harness}} avec ce compte.",
  "provider.connect.apiKey.description.engine": "Saisissez votre clé API {{vendor}} pour utiliser les modèles {{vendor}} dans {{engine}}.",
  ...
  "provider.connect.oauth.description.harness": "Connectez-vous avec {{method}}. Claxedo conserve le jeton et exécute {{harness}} avec.",
  "provider.connect.oauth.description.engine": "Connectez-vous avec {{method}}. Claxedo conserve le jeton reçu et l'utilise pour {{vendor}} dans {{engine}}.",
  ...
  "settings.providers.agents.machineSource": "depuis {{origin}}",
  "settings.providers.agents.addAnotherAccount": "+ Ajouter un autre compte",
  "settings.providers.agents.addFirstAccount": "Ajouter un compte",
