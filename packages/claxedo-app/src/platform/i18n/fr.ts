export const dict = {
  ...
  "settings.general.row.shell.description":
    "Choisissez le shell utilisé pour votre terminal. Les shells compatibles sont également utilisés pour les appels d'outils de l'agent.",
  ...
  "settings.general.row.showFileTree.description":
    "Afficher le bouton et le panneau de l'arborescence de fichiers dans les sessions de bureau",
  "settings.general.row.showNavigation.title": "Contrôles de navigation",
  "settings.general.row.showNavigation.description":
    "Afficher les boutons précédent et suivant dans la barre de titre du bureau",
  ...
  "settings.general.row.pinchZoom.description":
    "Autoriser les gestes de pincement sur le trackpad et Ctrl-molette pour zoomer",
  ...
  "workspace.creating": "Création de l'espace de travail...",
