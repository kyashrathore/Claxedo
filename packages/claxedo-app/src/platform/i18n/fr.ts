export const dict = {
  ...
  "provider.connect.changeMethod": "Changer",
  ...
  "settings.models.group.count": "{{enabled}} sur {{total}}",
  "settings.models.group.enableAll": "Tout activer",
  "settings.models.group.disableAll": "Tout désactiver",
  "settings.models.tab.accounts": "Comptes",
  "settings.models.tab.models": "Modèles",
  "settings.models.accounts.connection": "{{harness}} fonctionne avec la connexion configurée pour lui.",
  "settings.models.group.expand": "Afficher les modèles {{provider}}",
