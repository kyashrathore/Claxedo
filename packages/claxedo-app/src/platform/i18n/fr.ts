export const dict = {
  ...
  "session.share.level.follow": "Peut suivre",
  "session.share.level.send": "Peut envoyer des messages",
  ...
  "workspace.directory.project": "projet",
  "workspace.directory.sandbox": "bac à sable",
