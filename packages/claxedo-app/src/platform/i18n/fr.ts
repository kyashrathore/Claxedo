export const dict = {
  ...
  "dialog.deeplink.open.title": "Ouvrir ce dossier comme projet ?",
  "dialog.deeplink.open.body": "Un lien ouvert en dehors de Claxedo a demandé à ajouter ce dossier à vos projets :\n\n{{directory}}",
  "dialog.deeplink.open.prompt": "Le lien contient aussi ce texte de prompt :\n\n{{prompt}}",
  "dialog.deeplink.open.confirm": "Ouvrir",
