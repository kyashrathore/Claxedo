...
export type WorkspaceScopedQueryKey = Brand<
  readonly ["shell", "workspace", string, ...ReadonlyArray<unknown>],
  "workspace"
>
...
export const shellDataKeys = {
  ...
  session: (ref: SessionRef, ...parts: ReadonlyArray<unknown>) => shellDataKeys.sessionId(sessionKey(ref), ...parts),
