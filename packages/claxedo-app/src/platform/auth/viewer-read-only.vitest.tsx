...
import { createMemo, flush, onSettled } from "solid-js"
...
describe("viewer read-only role gates", () => {
  ...
  test("viewer disables submit and hides mutating controls without remounting on role flip", () => {
    ...
    const Surface = () => {
      ...
      return (
        <section>
          <button data-testid="submit" disabled={submitBlocked()}>
            Send
          </button>
    ...
    flush(() => internals.applyWorkspaceConnectionInfo(relayInfo("owner")))
