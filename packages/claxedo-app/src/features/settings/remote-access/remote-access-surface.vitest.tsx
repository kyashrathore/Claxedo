...
describe("before remote access is on", () => {
  test("renders blocker-honest locked copy and cannot enable", () => {
    ...
    // Drawn, and refused: the control the build will have says what is missing
    // more plainly than its absence does.
    expect(screen.getByRole("button", { name: /enable remote access/i })).toBeDisabled()
  })
