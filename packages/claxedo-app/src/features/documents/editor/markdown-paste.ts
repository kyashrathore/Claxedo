 ...
 * text would throw that away. The parse is the editor's own markdown manager,
 * so paste, typing and loading all agree.
 */
export function markdownFromPaste(input: { html: string; text: string }): string | undefined {
