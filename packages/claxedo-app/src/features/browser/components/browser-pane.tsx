...
function BrowserAddressBar(props: { initialUrl?: string; api?: BrowserBridgeApi; history?: BrowserHistoryState }) {
  ...
  // actively editing (we don't want to stomp their draft mid-type). Focus stays in
  // the compute: blurring is what re-arms the sync for a URL that moved mid-edit.
  createEffect(
    () => (focused() ? undefined : ctx.currentUrl()),
    (live) => {
