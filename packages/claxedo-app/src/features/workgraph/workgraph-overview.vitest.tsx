...
describe("WorkGraph overview actions", () => {
  ...
  test("marks Streams without their own target as requiring configuration", async () => {
  ...
  test("shows Stream spend split by compiled profile", async () => {
    const metered = {
      ...
      spend: {
        ...
        totalTokens: 1_500,
        byProfile: [
          { profile: "Builder", totalUsd: 0.5, totalTokens: 1_000 },
          { profile: "Reviewer", totalUsd: 0.25, totalTokens: 500 },
        ],
        asOf: 2,
      },
    }
