      ...
      >
        ...
        >
          <PromptDragOverlay
            ...
            label={props.t(
              props.draggingType() === "@mention" ? "prompt.dropzone.file.label" : "prompt.dropzone.label",
            )}
          />
          <PromptContextItems
          ...
          <PromptImageAttachments
            ...
            onOpen={(attachment) =>
              props.showDialog(() => <ImagePreview src={attachment.dataUrl} alt={attachment.filename} />)
            }
          ...
          >
            <div class="relative max-h-[180px] overflow-y-auto no-scrollbar" ref={props.scrollRef}>
              ...
              <div
                ...
                class={[
                  "absolute top-0 inset-x-0 px-4 pt-4 pointer-events-none whitespace-nowrap truncate leading-5 text-compact font-body text-v2-text-text-faint [font-family:var(--font-family-sans)]",
                  { "font-mono!": props.mode() === "shell", hidden: props.dirty() },
                ]}
              >
