  ...
  return (
    <span data-slot="question-option-check" aria-hidden="true" onClick={props.onClick}>
      ...
      >
        <Show
          when={props.multi}
          fallback={<span data-slot="question-option-radio-dot" class="ui-question-option-radio-dot" />}
        >
...
export const SessionQuestionDock: Component<{ request: QuestionRequest; onSubmit: () => void }> = (props) => {
  ...
  return (
    <DockPrompt
      ...
      header={
        <>
          <div data-slot="question-header-title" class="ui-question-header-title">
            {summary()}
          </div>
