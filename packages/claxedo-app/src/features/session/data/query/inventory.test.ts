...
import {
  mapInventoryToSessions,
  mergeSignedInventoryProjects,
  signedInventoryItems,
    ...
    const [project] = signedInventoryProjects({
      workspaces: [
        { workspace_id: "ws_bare", project_id: "proj_1", access: "cloud", remote_directory: "/workspace" },
        {
          ...
          access: "cloud",
          remote_directory: "/w2",
          repo_url: "git@github.com:claxedo/opencode.git",
        },
      ],
    })
    expect(project?.name).toBe("claxedo/opencode")
    ...
    const [project] = signedInventoryProjects({
      workspaces: [
        ...
        },
        {
          ...
          project_id: "proj_1",
          access: "cloud",
          remote_directory: "/workspace-2",
          workspace_name: "feature",
        },
      ],
    })
    expect(Object.keys((project as { workspaces?: Record<string, unknown> }).workspaces ?? {})).toEqual([
      "/workspace",
      "/workspace-2",
    ])
  })
