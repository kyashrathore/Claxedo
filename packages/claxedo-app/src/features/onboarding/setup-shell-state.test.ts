...
describe("setup shell state", () => {
  test.each([
    [{ hasProjects: false, firstTurnCompleted: false, setupDismissed: false, checklistDismissed: false }, "form"],
    [{ hasProjects: false, firstTurnCompleted: false, setupDismissed: true, checklistDismissed: false }, "checklist"],
    [{ hasProjects: false, firstTurnCompleted: false, setupDismissed: true, checklistDismissed: true }, "hidden"],
    [{ hasProjects: false, firstTurnCompleted: true, setupDismissed: false, checklistDismissed: false }, "go-further"],
    [{ hasProjects: false, firstTurnCompleted: true, setupDismissed: true, checklistDismissed: false }, "go-further"],
    [{ hasProjects: true, firstTurnCompleted: false, setupDismissed: false, checklistDismissed: false }, "hidden"],
    [{ hasProjects: true, firstTurnCompleted: true, setupDismissed: false, checklistDismissed: false }, "hidden"],
