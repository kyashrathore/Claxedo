...
import { createModeScanner } from "@/features/terminal/core/mode-scan"
import { createQuerySuppressor } from "@/features/terminal/core/query-suppression"
  ...
  ws.addEventListener("message", (eventData: string | ArrayBuffer) => {
    if (eventData instanceof ArrayBuffer) {
      ...
      try {
        ...
        const next = meta && typeof meta === "object" ? Reflect.get(meta, "cursor") : undefined
