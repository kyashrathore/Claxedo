...
import { createEffect, createMemo, createSignal, createUniqueId, onCleanup, onSettled, omit } from "solid-js"
...
export const Terminal = (props: TerminalProps) => {
  ...
  createEffect(terminalColors, (colors) => backend?.setTheme(colors))
  ...
  createEffect(
    ...
    (should) => {
      ...
      if (!backend || didAutoFocus) return
      didAutoFocus = true
      queueMicrotask(() => {
        if (disposed) return
