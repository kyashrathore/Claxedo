...
beforeAll(async () => {
  ...
  vi.doMock("../../features/terminal/ui/content/terminal-content", () => ({
    TerminalContent: () => null,
  }))
  vi.doMock("../../features/documents/ui/content/page-content", () => ({
    PageContent: () => null,
  }))
  vi.doMock("../workbench/content/context-content", () => ({
    ContextContent: () => null,
  }))
  vi.doMock("../../features/documents/ui/content/pages-index-content", () => ({
...
describe("content surface contributions", () => {
  ...
  test("the default registry renders no hosted surface until the hosted set is added", () => {
    // Not hidden: Documents has no renderer at all in a local composition.
    const registry = mod.createContentSurfaceRegistry()
