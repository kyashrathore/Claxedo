...
import * as MAppIntegrationsAiConnectResolution from "@/app/integrations/ai-connect-resolution"
...
const sessionThunks: Thunks<SessionAppPorts> = {
  ...
  applyAIConnectionResults: port(MAppIntegrationsAiConnectResolution, "applyAIConnectionResults"),
