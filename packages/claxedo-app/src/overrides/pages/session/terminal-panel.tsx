...
export function TerminalPanel() {
  ...
  // CLAXEDO FIX: Do not spread `{ ...pty }` here. Spreading creates a new plain
  // object on every store update, causing the keyed <Show> below to see a new
  // reference and remount <Terminal> — which triggers onConnect → trim → store
  // update → remount in an infinite loop. Return the SolidJS store proxy directly
  // so keyed comparison is stable across property-level updates.
