 ...
 *
 * Claxedo override for session commands: routes terminal creation through
 * Workbench terminal surfaces and moves file-tree toggle off mod+\.
 */
    ...
    viewCommand({
      ...
      onSelect: () => {
        ...
        const dir =
          ...
          worktree.pinned ??
          worktree.default ??
          (params.dir ? base64Decode(params.dir) : undefined)
        if (!dir) return
