...
import { getClaxedoServerUrl, isDemoMode } from "@claxedo/utils/api"
...
function AuthenticatedLayout(
  ...
  const resolveDefaultUrl = () => {
    ...
    if (location.hostname.includes("opencode.ai")) return getClaxedoServerUrl()
    ...
    <RouterComponent base={base}>
      ...
      >
        ...
        <Route path="/:dir" component={DirectoryLayout}>
          ...
          <Route path="/terminal/:terminalId" component={() => <div class="hidden" />} />
        </Route>
      </Route>
    </RouterComponent>,
  )
