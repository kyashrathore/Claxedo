import { Component, createMemo, For, onMount, type JSX } from "solid-js"
  ...
  return (
    <div class="flex flex-col h-full overflow-y-auto no-scrollbar px-4 pb-10 sm:px-10 sm:pb-10">
      ...
      <div class="flex flex-col gap-8 w-full">
        ...
        {/* Extension-provided settings sections (e.g. Account for cloud mode) */}
        <For each={ext.app.settingsSections ?? []}>
          {(Section) => <Section t={language.t as (key: string) => string} />}
        </For>
      </div>
    </div>
  )
