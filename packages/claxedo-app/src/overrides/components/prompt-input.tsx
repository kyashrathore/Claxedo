...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  const scope = createMemo(() => acpScope({
    ...
    tabId: _sessionParams?.tabId?.() ?? params.tabId,
  }))
  ...
  const sessionKey = createMemo(() => {
    const dir = _sessionParams?.directory ? base64Encode(_sessionParams.directory()) : params.dir
    return `${dir}${resolvedSessionId() ? "/" + resolvedSessionId() : ""}`
  })
            ...
            >
              ...
              >
                <div class="pointer-events-auto flex items-center gap-2">
                  <Show when={booting()}>
                    <div class="flex items-center gap-1.5 rounded-md border border-border bg-surface-panel px-2 py-1 text-12-medium text-text-weak">
