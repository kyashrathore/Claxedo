...
const MIN_WAITING_MS = 450
const MAX_WAITING_MS = 5000
const MIN_READY_BYTES = 1
const COMMAND_MIN_WAITING_MS = 900
const COMMAND_MAX_WAITING_MS = 7000
const COMMAND_MIN_READY_BYTES = 2048
