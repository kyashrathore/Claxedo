...
// the authoritative harness producer and returns the raw option array. Keeping
// one mock wrapper for both let Tier M accept a route shape production never
// emits.
import type { AgentConfigOption } from "../../../../agent-sdk-runtime/src"
import type {
  HarnessConfigOption,
  OptionsResponse,
...
export function runtimeHarnessOptionsResponse(options: BoundHarnessConfigOption[]): AgentConfigOption[] {
  return options
}
