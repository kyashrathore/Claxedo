...
const vendoredUpstreamDebt = new Set(
  [
    ...
    ["packages/claxedo-app/src/components/titlebar.tsx", "focus-within:outline-offset-2"],
    ["packages/claxedo-app/src/components/titlebar.tsx", "text-[#FFF]"],
    ["packages/claxedo-app/src/components/dialog-edit-project.tsx", "hover:border-border-strong"],
    ["packages/claxedo-app/src/components/server/server-row.tsx", "text-text-invert-weak"],
    ["packages/claxedo-app/src/components/settings-keybinds.tsx", "text-text-subtle"],
    ["packages/claxedo-app/src/components/prompt-input/image-attachments.tsx", "text-white"],
    ["packages/claxedo-app/src/components/prompt-input/context-items.tsx", "text-text-invert-base"],
    ["packages/claxedo-app/src/components/prompt-input/slash-popover.tsx", "text-text-subtle"],
    ["packages/claxedo-app/src/pages/layout/sidebar-items.tsx", "text-icon-weak"],
