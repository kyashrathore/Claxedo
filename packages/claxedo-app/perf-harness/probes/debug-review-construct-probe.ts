...
// browser/scenarios/workspace-interactions.ts and workspace-lifecycle.ts). Keep them in sync — this probe is
...
//   CLAXEDO_PERF_MOCK_PORT=47123 bun probes/debug-review-construct-probe.ts
//   # reruns, once the dist is baked for that port:
//   CLAXEDO_PERF_SKIP_BUILD=1 CLAXEDO_PERF_MOCK_PORT=47123 \
//     bun probes/debug-review-construct-probe.ts
//
...
} from "../src/browser/scenarios/workspace-interactions-contract"
