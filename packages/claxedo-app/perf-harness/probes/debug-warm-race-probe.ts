...
//
// It reproduces phases 1 and 2 of browser/scenarios/workspace-lifecycle.ts -> workspaceLifecycle
...
//     bun probes/debug-warm-race-probe.ts [--early]
...
} from "../src/browser/scenarios/workspace-lifecycle-contract"
