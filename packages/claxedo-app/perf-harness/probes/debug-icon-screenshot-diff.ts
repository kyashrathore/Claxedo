...
//
// Run:
//   bun probes/debug-icon-screenshot-diff.ts /tmp/shots-base /tmp/shots-cand
...
if (!baseDir || !candDir) {
  console.error("usage: bun probes/debug-icon-screenshot-diff.ts <base-dir> <candidate-dir>")
  process.exit(2)
}
