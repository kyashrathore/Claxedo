import { bi as __vitePreload } from "./mermaid-classDiagram-DWBVSOg0.js";
import { m as map$1, f as flatten$1, d as min } from "./min-WV6PocAF.js";
import { b as baseFlatten$1, l as baseUniq$1, c as baseIteratee$1, m as filter$1, r as reduce$1, n as forEach$1 } from "./_baseUniq-N-cIHQzH.js";
import { i as isEmpty$1 } from "./mermaid.core-CJBzxvbd.js";
...
function baseUniq(array, iteratee, comparator) {
  var index = -1, includes2 = arrayIncludes, length = array.length, isCommon2 = true, result = [], seen = result;
...
class DefaultWorkspaceLock {
  ...
  write(action) {
    this.cancelWrite();
    const tokenSource = new cancellationExports.CancellationTokenSource();
  ...
  enqueue(queue, action, cancellationToken) {
    ...
    const entry = {
      action,
      deferred,
      cancellationToken: cancellationToken !== null && cancellationToken !== void 0 ? cancellationToken : cancellationExports.CancellationToken.None
    };
    queue.push(entry);
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await __vitePreload(async () => {
      const { createInfoServices: createInfoServices22 } = await Promise.resolve().then(() => info46DW6VJ7);
  ...
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await __vitePreload(async () => {
      const { createPacketServices: createPacketServices22 } = await Promise.resolve().then(() => packetW2GHVCYJ);
  ...
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await __vitePreload(async () => {
      const { createPieServices: createPieServices22 } = await Promise.resolve().then(() => pieBEWT4RHE);
  ...
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await __vitePreload(async () => {
      const { createArchitectureServices: createArchitectureServices22 } = await Promise.resolve().then(() => architectureI3QFYML2);
  ...
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await __vitePreload(async () => {
      const { createGitGraphServices: createGitGraphServices22 } = await Promise.resolve().then(() => gitGraphYCYPL57B);
