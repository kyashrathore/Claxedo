import { d5 as Node3, d8 as wrappingInputRule, d7 as mergeAttributes, dh as Mark, ds as markPasteRule, dt as markInputRule, dJ as textblockTypeInputRule, du as nodeInputRule, dK as canInsertNode, dL as isNodeSelection, di as TextSelection, dj as NodeSelection, dw as Plugin, dm as dropPoint, dp as Fragment, dl as Slice, dE as keydownHandler, dk as Selection, dx as PluginKey, dM as Mapping, db as Extension, dG as callOrReturn, dH as getExtensionField, dN as DecorationSet$1, dO as Decoration$1, dP as isNodeEmpty, dQ as CodeBlock } from "./main-CfU7H2cy.js";
import { Link } from "./index-ubqF9nJy.js";
import { B as BulletList, L as ListItem, b as ListKeymap, O as OrderedList } from "./index-BHoOqHRl.js";
import { Underline } from "./index-B0e5AIFe.js";
import { D as DecorationSet, a as Decoration } from "./index-BqzMivg3.js";
        ...
        props: {
          decorations: ({ doc, selection }) => {
            ...
            if (!isEditable || !isFocused) {
              return DecorationSet$1.create(doc, []);
            }
            let maxLevels = 0;
            ...
            doc.descendants((node, pos) => {
              ...
              decorations.push(
                Decoration$1.node(pos, pos + node.nodeSize, {
                  class: this.options.className
                })
              );
            });
            return DecorationSet$1.create(doc, decorations);
          }
        }
      })
    ];
          ...
          decorations: ({ doc, selection }) => {
            ...
            doc.descendants((node, pos) => {
              ...
              if ((hasAnchor || !this.options.showOnlyCurrent) && isEmpty) {
                ...
                const decoration = Decoration$1.node(pos, pos + node.nodeSize, {
                  class: classes.join(" "),
        ...
        props: {
          decorations(state) {
            ...
            return DecorationSet$1.create(state.doc, [
              Decoration$1.inline(state.selection.from, state.selection.to, {
