...
import { createEffect, onCleanup, onSettled, Show, type Accessor } from "solid-js"
            ...
            <ServerGate>
              {(data) => {
                ...
                const ThemeSync = () => {
                  ...
                  createEffect(
                    () => theme.colorScheme(),
                    (colorScheme) => desktopApi().setNativeTheme(colorScheme),
                  )
                  return null
                }
