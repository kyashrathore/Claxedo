...
export const GREENFIELD_CONTROL_PLANE_TABLE_COUNTS = Object.freeze({
  actors: 0,
  agent_plugin_artifact_pins: 0,
  agent_plugin_claxedo_defaults: 0,
  agent_plugin_organization_defaults: 0,
  agent_plugin_project_overrides: 0,
  agent_plugin_revisions: 0,
  agent_plugin_sources: 0,
  agent_plugin_user_defaults: 0,
  auth_identities: 0,
  authority_audit_events: 0,
  authority_batch_assertions: 0,
  channel_identity_bindings: 0,
  control_plane_recovery_epochs: 1,
  host_assignment_readiness: 0,
  host_enrollment_requests: 0,
  host_enrollments: 0,
  host_invitations: 0,
  host_request_nonces: 0,
  host_signature_uses: 0,
  host_workspace_assignments: 0,
  hosted_connection_attempts: 0,
  hosted_connections: 0,
  hosted_provider_credentials: 0,
  mcp_oauth_clients: 0,
  org_memberships: 0,
  orgs: 0,
