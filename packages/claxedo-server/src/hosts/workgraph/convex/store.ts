...
import { workGraphConvexApi } from "./api"
...
export function createConvexWorkGraphStore(input: Input) {
  ...
  return defineAtomicWorkGraphStore({
    ...
    queries: {
      ...
      changes: {
        list: async (context: WorkGraphContext, queryInput: Readonly<{ after?: ChangeCursor; deliveredEventIds?: readonly string[]; limit?: number }>) =>
