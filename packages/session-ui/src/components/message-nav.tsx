...
import { For, Match, Show, Switch, createMemo, createSignal, onCleanup, omit } from "solid-js"
              ...
              return (
                ...
                >
                  <div data-slot="message-nav-preview-copy">
                    <p data-slot="message-nav-preview-user" class="ui-message-nav-preview-user">
                      {preview()?.user ?? fallbackLabel(message)}
                    </p>
                    <Show when={preview()?.assistant}>
                      {(assistant) => (
                        <p data-slot="message-nav-preview-assistant" class="ui-message-nav-preview-assistant">
                          {assistant()}
                        </p>
                      )}
                    </Show>
            ...
            <li data-slot="message-nav-item">
              ...
              >
                ...
                <div
                  ...
                  class="ui-message-nav-title-preview"
