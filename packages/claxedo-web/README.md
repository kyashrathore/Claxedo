...
The Astro application for Claxedo's canonical public site. It owns commercial pages, downloads, maintained comparisons, and machine-readable discovery on `claxedo.com`.
...
- `src/content/routes.ts` owns canonical public destinations and the download action.
