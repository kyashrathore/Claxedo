...
[`@claxedo/sandbox-manager`](/framework/packages/sandbox-manager) for the per-driver
capability matrix.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="@claxedo/workspace-relay" href="/framework/packages/workspace-relay" icon="tower-broadcast">
