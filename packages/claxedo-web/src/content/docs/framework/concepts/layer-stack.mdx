...
Claxedo is layered so each concern has exactly one owner. An event starts at a
...
Zoom, pan, or open the diagram fullscreen with the controls in its corner.
Package nodes link to their reference pages.
...
<CardGroup cols={2}>
  ...
  <Card title="Deploy" href="/framework/deploy/local" icon="cloud">
    Local, private VM, relay-attached, and hosted control plane.
  </Card>
</CardGroup>
