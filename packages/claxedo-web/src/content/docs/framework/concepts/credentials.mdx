...
<CardGroup cols={2}>
  <Card title="@claxedo/connections" href="/framework/packages/connections" icon="plug">
    The kit: registry, ports, reference integrations, and the token API.
  </Card>
  <Card title="@claxedo/sandbox-manager" href="/framework/packages/sandbox-manager" icon="lock">
