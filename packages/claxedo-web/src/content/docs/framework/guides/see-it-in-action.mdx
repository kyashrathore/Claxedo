...
See [`@claxedo/workspace-runtime`](/framework/packages/workspace-runtime) for the full
relay-attachment env contract.

## Go deeper

<CardGroup cols={2}>
  <Card title="Deploy the stack" href="/framework/deploy/cloudflare-full-stack" icon="cloud">
    The full Claxedo stack on Cloudflare, the same shape hosted Claxedo runs.
  </Card>
  <Card title="Package reference" href="/framework/packages/index" icon="box">
