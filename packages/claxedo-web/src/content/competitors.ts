...
export const competitors: readonly Competitor[] = [
  {
    ...
    chooseClaxedo: "you want permissive open source, integrated multi-user organization scoping, and portable agent setup.",
    sources: [
  ...
  },
  {
    ...
    chooseClaxedo: "you want generic ACP and Gemini support, cross-platform desktop clients, open source, or a self-hosted control plane.",
    sources: [
  ...
  },
  {
    ...
    chooseClaxedo: "you need organization-scoped teams, generic ACP or Gemini support, or portable setup across sandboxes.",
    sources: [
