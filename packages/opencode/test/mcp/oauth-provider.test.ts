...
// The "MCP OAuth scope selection" tests exercised the SDK's own
// determineScope(), which the SDK removed; scope selection is SDK-internal
// now and there is no first-party logic here to cover.
