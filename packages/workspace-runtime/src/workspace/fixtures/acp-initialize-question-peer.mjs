...
readline.createInterface({ input: process.stdin }).on("line", line => {
  ...
  if (message.method === "initialize") {
    ...
    if (message.result.action !== "accept") return send({ id: initialize, error: { code: -32603, message: "User declined initialization" } })
    send({ id: initialize, result: { protocolVersion: 1, agentCapabilities: {}, authMethods: [] } })
