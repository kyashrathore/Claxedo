...
import type { SessionStatus as ViewStatus } from "@opencode-ai/sdk/v2/client"
...
export function live(input: RetryRow, fallback: string, now = Date.now()): ViewStatus | undefined {
