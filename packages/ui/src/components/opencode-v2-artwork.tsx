/** Source OpenCode v2 geometry. Both renderer generations reference this table. */
export const OPEN_CODE_V2_ARTWORK = {
  edit: {
    viewBox: "0 0 16 16",
  ...
  "outline-copy": {
    viewBox: "0 0 16 16",
    body: `<rect x="5.5" y="5" width="8.5" height="8.5" rx="2" stroke="currentColor"/><path d="M10.5 2.5H4.5C3.39543 2.5 2.5 3.39543 2.5 4.5V10.5" stroke="currentColor" stroke-linecap="round"/>`,
  },
  "open-external": {
    viewBox: "0 0 16 16",
