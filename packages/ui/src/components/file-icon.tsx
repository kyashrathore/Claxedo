...
import { createEffect, createMemo, createUniqueId, omit, Show } from "solid-js"
...
export const FileIcon: Component<FileIconProps> = (props) => {
  ...
  createEffect(name, (value) => fileIconSprite.ensure(value))
  return (
    <svg data-component="file-icon" {...rest} class={["ui-file-icon", local.class]}>
