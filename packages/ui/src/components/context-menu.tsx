...
function ContextMenuContent(props: ParentProps<ContextMenuContentProps>) {
  const local = props,
    rest = omit(props, "class", "children")
  return (
    <Kobalte.Content {...rest} data-component="context-menu-content" class={["ui-context-menu-content", local.class]}>
      {local.children}
    </Kobalte.Content>
  )
}
...
function ContextMenuSubTrigger(props: ParentProps<ContextMenuSubTriggerProps>) {
  ...
  return (
    <Kobalte.SubTrigger
      ...
      class={["ui-context-menu-sub-trigger", local.class]}
    >
      {local.children}
    </Kobalte.SubTrigger>
  )
...
function ContextMenuSubContent(props: ParentProps<ContextMenuSubContentProps>) {
  ...
  return (
    <Kobalte.SubContent
      ...
      class={["ui-context-menu-sub-content", local.class]}
    >
      {local.children}
    </Kobalte.SubContent>
  )
