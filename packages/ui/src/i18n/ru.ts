export const dict = {
  ...
  "ui.scrollableOutput.showAll": "Показать всё",
  "ui.scrollableOutput.showLess": "Свернуть",
  ...
  "ui.basicTool.title.to": "{{action}} для",
  "ui.basicTool.action.sendMessage": "Отправить сообщение",
