...
export const dict = {
  ...
  "ui.scrollableOutput.showAll": "Alles anzeigen",
  "ui.scrollableOutput.showLess": "Weniger anzeigen",
  ...
  "ui.basicTool.title.to": "{{action}} an",
  "ui.basicTool.action.sendMessage": "Nachricht senden",
  "ui.basicTool.action.searchTools": "Werkzeuge suchen",
  "ui.basicTool.action.listAgents": "Agenten auflisten",
  "ui.toolErrorCard.failed": "Fehlgeschlagen",
  "ui.tool.shell.exit": "Exit-Code {{code}}",
