...
export const dict = {
  ...
  "ui.basicTool.title.to": "{{action}}至",
  "ui.basicTool.action.sendMessage": "傳送訊息",
  "ui.basicTool.action.searchTools": "搜尋工具",
  "ui.basicTool.action.listAgents": "列出代理程式",
  "ui.toolErrorCard.failed": "失敗",
  "ui.tool.shell.exit": "結束碼 {{code}}",
