export const dict = {
  ...
  "ui.scrollableOutput.showAll": "Tout afficher",
  "ui.scrollableOutput.showLess": "Afficher moins",
  ...
  "ui.basicTool.title.to": "{{action}} à",
  "ui.basicTool.action.sendMessage": "Envoyer un message",
  "ui.basicTool.action.searchTools": "Rechercher des outils",
  "ui.basicTool.action.listAgents": "Lister les agents",
  "ui.toolErrorCard.failed": "Échoué",
  "ui.tool.shell.exit": "code de sortie {{code}}",
