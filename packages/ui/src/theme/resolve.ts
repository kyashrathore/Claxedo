...
import { blend, contrastRatio, generateNeutralScale, generateScale, hexToOklch, isHexColor, shift, withAlpha } from "./color"
...
export function resolveThemeVariant(variant: ThemeVariant, isDark: boolean): ResolvedTheme {
  ...
  const on = (fill: HexColor) => {
    const light: HexColor = "#ffffff"
    const dark: HexColor = "#000000"
