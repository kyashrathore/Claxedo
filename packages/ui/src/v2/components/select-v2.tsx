  ...
  return (
    ...
    >
      <Kobalte.Trigger
        ...
        class={["ui-select-v2", local.class]}
      >
        <div data-slot="select-v2-value">
          <Kobalte.Value<T> data-slot="select-v2-value-text" class={[local.valueClass, "ui-select-v2-value-text"]}>
            {(st) => {
