...
[![npm version](https://img.shields.io/npm/v/%40claxedo%2Fworkspace-runtime.svg)](https://www.npmjs.com/package/@claxedo/workspace-runtime)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](./LICENSE)

**[claxedo.com](https://claxedo.com) · [docs.claxedo.com](https://docs.claxedo.com) · [npm: @claxedo/\*](https://www.npmjs.com/search?q=%40claxedo)**
...
Each package is independently usable; most full products start with `@claxedo/workspace-runtime`. See the [install guide](https://docs.claxedo.com/guides/install) and [quickstart](https://docs.claxedo.com/guides/see-it-in-action) for the whole set.
