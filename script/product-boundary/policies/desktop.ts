...
export const desktopRendererUnsigned: Policy = {
  ...
  // +3 modules / 0 packages (2026-09-07): the same app, so it also takes
  // app-local's connected-applications surface verbatim — see that ledger.
  // Re-measured, no headroom.
  ceilings: { modules: 1014, packages: 57 },
  emitted: {
