...
1. **P1 — Markdown paste silently drops unsupported content** — [markdown-paste.ts:44](packages/claxedo-app/src/features/documents/editor/markdown-paste.ts:44)
...
2. **P1 — External description replacements bypass the fidelity gate** — [tasks-prose-editor.tsx:25](packages/claxedo-app/src/app/integrations/tasks/tasks-prose-editor.tsx:25)
...
3. **P2 — Ordinary inline paste splits the surrounding paragraph** — [markdown-paste.ts:47](packages/claxedo-app/src/features/documents/editor/markdown-paste.ts:47)
...
4. **P2 — “Create a preset” from a row opens nothing** — [tasks-view.tsx:121](packages/claxedo-app/src/features/tasks/ui/tasks-view.tsx:121)
...
5. **P2 — Rows open deleted sessions and cannot restart their slot** — [start-task.ts:103](packages/claxedo-app/src/features/tasks/data/start-task.ts:103), [start-task.ts:79](packages/claxedo-app/src/features/tasks/data/start-task.ts:79)
...
6. **P2 — Default subtask progress excludes completed children** — [tasks-view.tsx:67](packages/claxedo-app/src/features/tasks/ui/tasks-view.tsx:67)
