...
```
Error: assistant reply "PI-UNSUPPORTED-1789365882247" never appeared in a visible assistant-content slot

expect(locator).toBeVisible() failed

Locator: locator('[data-slot="session-turn-assistant-content"]:not([aria-hidden="true"])').filter({ hasText: 'PI-UNSUPPORTED-1789365882247' }).last()
Expected: visible
Timeout: 20000ms
Error: element(s) not found

Call log:
  - assistant reply "PI-UNSUPPORTED-1789365882247" never appeared in a visible assistant-content slot with timeout 20000ms
  - waiting for locator('[data-slot="session-turn-assistant-content"]:not([aria-hidden="true"])').filter({ hasText: 'PI-UNSUPPORTED-1789365882247' }).last()
...
- navigation:
  - navigation "Projects and sessions":
    ...
    - text: claxedo-tier-real-pi-subagent-MjGUSt
    - 'button "Reply with exactly this one token: PI-UNSUPPORTED-1789365882247"'
    - text: "Reply with exactly this one token: PI-UNSUPPORTED-1789365882247 18s"
    - button "Test User"
- main:
  - button "New Session"
  - button "New Terminal"
  ...
  - region "scrollable content":
    - 'heading "Reply with exactly this one token: PI-UNSUPPORTED-1789365882247" [level=1]'
    - button "More options"
    - text: "Reply with exactly this one token: PI-UNSUPPORTED-1789365882247 Build · openai/gpt-4 · 11:34 AM"
    - button "Copy message"
    - status:
