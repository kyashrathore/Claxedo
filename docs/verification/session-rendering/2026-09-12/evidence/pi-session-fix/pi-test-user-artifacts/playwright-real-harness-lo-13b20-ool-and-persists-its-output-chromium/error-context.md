...
```
Error: assistant reply "PI-BASH-1789365856706" never appeared in a visible assistant-content slot

expect(locator).toBeVisible() failed

Locator: locator('[data-slot="session-turn-assistant-content"]:not([aria-hidden="true"])').filter({ hasText: 'PI-BASH-1789365856706' }).last()
Expected: visible
Timeout: 20000ms
Error: element(s) not found

Call log:
  - assistant reply "PI-BASH-1789365856706" never appeared in a visible assistant-content slot with timeout 20000ms
  - waiting for locator('[data-slot="session-turn-assistant-content"]:not([aria-hidden="true"])').filter({ hasText: 'PI-BASH-1789365856706' }).last()
...
- navigation:
  - navigation "Projects and sessions":
    ...
    - text: claxedo-tier-real-pi-bash-QOwtr6
...
- main:
  ...
  - region "scrollable content":
    ...
    - button "More options"
    - text: "Run the command, then reply with exactly this one token and nothing else: PI-BASH-1789365856706 Build · openai/gpt-4 · 11:34 AM"
    - button "Copy message"
    - status:
