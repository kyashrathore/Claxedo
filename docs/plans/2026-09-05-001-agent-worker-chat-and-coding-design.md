...
Status: proposed architecture and UX; no runtime changes implemented by this document.
...
Companion: [Chat, tools, and coding environments — draft user guide](/Users/yashvardhansingh/test/opencode/docs/guides/chat-tools-and-coding-environments.md). It explains the machine as a tool and the proposed extended-Pi worker setup. Both documents describe the target experience, not currently shipped features.
...
- **S1:** [ControlPlaneSessionRoutes / hybrid creation](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/session/routes/control-plane-session.ts:279).
- **S2:** [MCP session dispatch](/Users/yashvardhansingh/test/opencode/packages/claxedo-mcp/src/server.ts:516).
- **S3:** [createCentralSessionRuntime](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/session/runtime.ts:304), [recovery](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/session/runtime.ts:551), [event ingress](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/session/runtime.ts:724), [createHybridSession](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/session/runtime.ts:863).
- **S4:** [central authorization](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/central-runtime.ts:82), [createCentralControlApp](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/central-runtime.ts:162).
- **S5:** [Node deployment composition](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/deployments/self-hosted-node/app.ts:856).
- **S6:** [UI session target acquisition](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/composer/ui/submit-create-session.ts:140), [normal prompt dispatch](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/composer/ui/submit-normal-prompt.ts:1).
- **S7:** [submit transport](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/composer/ui/submit-transport.ts:99), [centralRuntimePath](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/platform/runtime/agent/central-runtime-path.ts:3).
- **S8:** [shared message route](/Users/yashvardhansingh/test/opencode/packages/workspace-runtime/src/routes/session-core.ts:1284), [createAgentRuntime](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/runtime.ts:96).
- **S9:** [PiHarnessAdapter](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/harnesses/pi/index.ts:197), [native recovery limitation](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/harnesses/pi/index.ts:332), [binding](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/harnesses/pi/index.ts:507), [environment swap](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/harnesses/pi/index.ts:642).
- **S10:** [Pi model backend and tool injection](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/harnesses/pi/model-backend.ts:119).
- **S11:** [SessionEnv contract](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/session-env.ts:1), [virtual environment](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/virtual-session-env.ts:20).
- **S12:** [environment factory](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/hosts/workspace-runtime/session-env-factory.ts:11), [remote tools](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/hosts/workspace-runtime/workspace-runtime-session-env.ts:37), [worktree admission](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/hosts/workspace-runtime/workspace-session-admission.ts:18).
- **S13:** [workspace Pi registration](/Users/yashvardhansingh/test/opencode/packages/workspace-runtime/src/workspace/runtime.ts:814).
- **S14:** [SessionRef and Pi-only directory-less rule](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/platform/identity/session-ref.ts:1).
- **S15:** [runtime resource client](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/platform/runtime/agent/agent-runtime-client.ts:249), [resolveRuntimePlacement](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/platform/runtime/agent/placement-table.ts:62).
- **S16:** [Environment card and source contract](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/ui/content/session-environment-card.tsx:1), [session feature boundary](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/AGENTS.md).
- **S17:** [runtime session authority](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/routes/runtime-session-authority.ts:1), [session turn authority contract](/Users/yashvardhansingh/test/opencode/packages/claxedo-server-core/src/platform/auth/session-turn-authority.ts:1).
- **S18:** [connection turn credentials](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/connections/turn-credentials.ts:25).
- **S19:** [central subagent composition](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/session/runtime.ts:1067), [channel composition](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/channels/control-plane.ts:1).
- **S20:** [sandbox driver capabilities and egress policy](/Users/yashvardhansingh/test/opencode/packages/sandbox-manager/src/index.ts:82), [checkpoint manager](/Users/yashvardhansingh/test/opencode/packages/sandbox-manager/src/checkpoint-manager.ts:1).
- **S21:** [OpenCode adapter and injected request transport](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/harnesses/opencode/index.ts:75).
- **S22:** [session metadata and reference-linked children](/Users/yashvardhansingh/test/opencode/packages/claxedo-server-core/src/session/meta/index.ts:1).
- **S23:** [extension targets and scopes](/Users/yashvardhansingh/test/opencode/packages/agent-extensions/src/types.ts:1), [package installation](/Users/yashvardhansingh/test/opencode/packages/agent-extensions/src/install.ts:1), [content-bound project trust](/Users/yashvardhansingh/test/opencode/packages/agent-extensions/src/trust.ts:1), [materializer](/Users/yashvardhansingh/test/opencode/packages/agent-extensions/src/materialize.ts:1), [integrity verification](/Users/yashvardhansingh/test/opencode/packages/agent-extensions/src/integrity.ts:1), [extensions feature boundary](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/extensions/AGENTS.md).
- **S24:** [hosted workerd core composition](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/deployments/hosted-workerd/core-worker.cf.ts:1), [resource closure tests](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/deployments/hosted-workerd/core-resource-closure.test.ts:1), [durable wake lane](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/src/deployments/hosted-workerd/wake-lane.cf.ts:1).
- **S25:** [Pi scripted model helper](/Users/yashvardhansingh/test/opencode/packages/agent-sdk-runtime/src/harnesses/pi/test-worker-stream.ts:1), [certified workerd artifact inventory](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/scripts/boundary/certified-workerd-boundary.ts:1), [workerd smoke scope](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/scripts/boundary/smoke-workerd.ts:1), [package validation commands](/Users/yashvardhansingh/test/opencode/packages/claxedo-server/package.json:68).
- **S26:** [new-session environment and workspace chips](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/ui/components/session-new-design-view.tsx:234), [hosted and desktop destination options](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/ui/components/session-new-workspace-options.ts:35), [draft target contract](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/composer/mode.ts:5).
- **S27:** [per-harness draft preferences](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/harness/draft-defaults.ts:16), [default resolution and authority guard](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/harness/draft-default-policy.ts:1), [draft versus session authority](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/session/harness/store-state.ts:43).
