...
- **S23:** extension targets and scopes, package installation, content-bound project trust, materializer, and integrity verification (the retired `agent-extensions` package, replaced by Agent Plugins under `packages/claxedo-local-server/src/agent-plugins/`), [extensions feature boundary](/Users/yashvardhansingh/test/opencode/packages/claxedo-app/src/features/extensions/AGENTS.md).
