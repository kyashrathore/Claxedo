...
| W3 | Credentials engine-bridge scoped to the OpenCode domain: a credential write never boots the engine | 2026-08-19-002-refactor-opencode-engine-auth-bridge-scoping-plan.md (`2026-08-19-002-refactor-opencode-engine-auth-bridge-scoping-plan.md`, executed and removed 2026-09-05) | DONE (2026-08-19) |
| W4 | Embedded engine becomes an opencode-adapter implementation detail: no engine load unless an OpenCode surface is used; unknown runners no longer fall through to OpenCode | 2026-08-19-003-refactor-opencode-engine-as-adapter-detail-plan.md (`2026-08-19-003-refactor-opencode-engine-as-adapter-detail-plan.md`, executed and removed 2026-09-05) | DONE (2026-08-19; see note below) |
