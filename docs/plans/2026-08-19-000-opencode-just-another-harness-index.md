...
|---|-----------|------|--------|
| W1 | Open the harness surface: any operator-configured stdio ACP agent becomes a selectable harness; first-party ACP duplicates removed | [2026-07-22-001-refactor-scriptable-acp-connections-plan.md](./2026-07-22-001-refactor-scriptable-acp-connections-plan.md) (pre-existing, `status: active`) | Units 1–3 landed 2026-08-19 (open identity, trusted-config registry + mutation API, runtime enforcement). Units 4–6 remain: 4 (app picker discovery UI), 5 (independent interop pin — blocked on choosing/pinning a non-first-party ACP implementation and its test credentials), 6 (first-party ACP artifact removal — gated on the Native Readiness Gate). |
